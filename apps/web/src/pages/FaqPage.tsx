...
const CONTENT: Record<Lang, FaqContent> = {
  ...
  en: {
    ...
    items: [
      ...
      { q: 'What does the score out of 10 mean?', a: 'It is the number of quality criteria passed out of 10, each tested against a threshold drawn from the financial literature (profitability, revenue and free cash flow per share growth, buybacks, FCF margin, operating leverage, Cash ROCE, net debt to FCF, cash conversion, cash conversion cycle). A score of 8 out of 10 means 8 criteria are passed.' },
  ...
  es: {
    ...
    items: [
      ...
      { q: '¿Qué significa la nota sobre 10?', a: 'Es el número de criterios de calidad validados sobre 10, cada uno comparado con un umbral sacado de la literatura financiera (rentabilidad, crecimiento de los ingresos y del free cash flow por acción, recompras, margen de FCF, apalancamiento operativo, Cash ROCE, deuda neta sobre FCF, conversión del cash, ciclo de tesorería). Una nota de 8 sobre 10 significa que se validan 8 criterios.' },
