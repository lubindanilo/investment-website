...
const CATALOG: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'revenuePerEmployeeGrowth5y.target': '> 5 %/an sur 5 ans',
    'revenuePerEmployeeGrowth5y.strong': 'Productivité par employé en nette progression',
    'revenuePerEmployeeGrowth5y.stable': 'Productivité par employé stable',
    'revenuePerEmployeeGrowth5y.declining': 'Productivité par employé en recul',
  ...
  en: {
    ...
    'revenuePerEmployeeGrowth5y.target': '> 5 %/year over 5 years',
    'revenuePerEmployeeGrowth5y.strong': 'Strong productivity gains per employee',
    'revenuePerEmployeeGrowth5y.stable': 'Flat revenue per employee',
    'revenuePerEmployeeGrowth5y.declining': 'Declining revenue per employee',
  ...
  es: {
    ...
    'revenuePerEmployeeGrowth5y.target': '> 5 %/año en 5 años',
    'revenuePerEmployeeGrowth5y.strong': 'Clara mejora de la productividad por empleado',
    'revenuePerEmployeeGrowth5y.stable': 'Ingresos por empleado estables',
    'revenuePerEmployeeGrowth5y.declining': 'Ingresos por empleado en retroceso',
