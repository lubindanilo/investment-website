...
const CATALOG: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'netDebtFcf.netcashShort': 'Pas de dette nette',
  ...
  en: {
    ...
    'revenueGrowth5y.target': '> 10 %/year over 5 years',
    ...
    'fcfGrowth5y.target': '> 10 %/year over 5 years',
    ...
    'netDebtFcf.netcashShort': 'No net debt',
  ...
  es: {
    ...
    'netDebtFcf.netcashShort': 'Sin deuda neta',
