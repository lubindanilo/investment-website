...
const CATALOG: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'netMargin.target': '> 5 % de marge nette',
    ...
    // revenuePerEmployeeGrowth5y (critère n°5 ; fcfMargin reste son repli quand l'effectif manque)
    'revenuePerEmployeeGrowth5y.name': 'CA par employé en progression',
    'revenuePerEmployeeGrowth5y.target': 'CA et CA par employé ≥ 10 %/an sur 5 ans',
    'revenuePerEmployeeGrowth5y.strong': 'CA et CA par employé progressent d’au moins 10 %/an',
    'revenuePerEmployeeGrowth5y.employeeStrongRevenueWeak': 'CA par employé ≥ 10 %/an, mais croissance du CA sous 10 %/an',
    'revenuePerEmployeeGrowth5y.revenueStrongEmployeePartial': 'CA ≥ 10 %/an, mais CA par employé entre 5 % et 10 %/an',
    'revenuePerEmployeeGrowth5y.revenueUnavailable': 'CA par employé ≥ 10 %/an, mais croissance du CA indisponible',
    'revenuePerEmployeeGrowth5y.weak': 'Croissance combinée du CA et du CA par employé insuffisante',
    'revenuePerEmployeeGrowth5y.unavailable': 'Historique d\'effectifs indisponible',
    // operatingLeverage
  ...
  en: {
    ...
    'revenuePerEmployeeGrowth5y.name': 'Growing revenue per employee',
    'revenuePerEmployeeGrowth5y.target': 'Revenue and revenue per employee ≥ 10%/year over 5 years',
    'revenuePerEmployeeGrowth5y.strong': 'Revenue and revenue per employee both grow by at least 10%/year',
    'revenuePerEmployeeGrowth5y.employeeStrongRevenueWeak': 'Revenue per employee ≥ 10%/year, but revenue growth is below 10%/year',
    'revenuePerEmployeeGrowth5y.revenueStrongEmployeePartial': 'Revenue ≥ 10%/year, but revenue per employee is between 5% and 10%/year',
    'revenuePerEmployeeGrowth5y.revenueUnavailable': 'Revenue per employee ≥ 10%/year, but revenue growth is unavailable',
    'revenuePerEmployeeGrowth5y.weak': 'Combined revenue and revenue-per-employee growth is insufficient',
    'revenuePerEmployeeGrowth5y.unavailable': 'Employee history unavailable',
  ...
  es: {
    ...
    'netMargin.target': '> 5 % de margen neto',
    ...
    'revenuePerEmployeeGrowth5y.name': 'Ingresos por empleado en crecimiento',
    'revenuePerEmployeeGrowth5y.target': 'Ingresos e ingresos por empleado ≥ 10%/año en 5 años',
    'revenuePerEmployeeGrowth5y.strong': 'Los ingresos y los ingresos por empleado crecen al menos un 10%/año',
    'revenuePerEmployeeGrowth5y.employeeStrongRevenueWeak': 'Ingresos por empleado ≥ 10%/año, pero crecimiento de ingresos inferior al 10%/año',
    'revenuePerEmployeeGrowth5y.revenueStrongEmployeePartial': 'Ingresos ≥ 10%/año, pero ingresos por empleado entre 5% y 10%/año',
    'revenuePerEmployeeGrowth5y.revenueUnavailable': 'Ingresos por empleado ≥ 10%/año, pero crecimiento de ingresos no disponible',
    'revenuePerEmployeeGrowth5y.weak': 'El crecimiento combinado de ingresos e ingresos por empleado es insuficiente',
    'revenuePerEmployeeGrowth5y.unavailable': 'Historial de plantilla no disponible',
