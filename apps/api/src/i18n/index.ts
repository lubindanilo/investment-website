...
const CATALOG: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'currentRatio.target': '< 1 (BFR négatif)',
    'currentRatio.strong': '{{x}} — les clients payent avant les fournisseurs (modèle type Amazon, Costco)',
    'currentRatio.classic': '{{x}} — équilibre classique entre actifs courants et passifs courants',
    'currentRatio.heavy': '{{x}} — beaucoup de capital immobilisé en stocks et créances clients',
  ...
  en: {
    ...
    'currentRatio.name': 'Current Ratio',
    'currentRatio.target': '< 1 (negative working capital)',
    'currentRatio.strong': '{{x}} — customers pay before suppliers (Amazon/Costco-style model)',
    'currentRatio.classic': '{{x}} — classic balance between current assets and liabilities',
  ...
  es: {
    ...
    'currentRatio.name': 'Current Ratio',
    'currentRatio.target': '< 1 (capital circulante negativo)',
    'currentRatio.strong': '{{x}} — los clientes pagan antes que los proveedores (modelo tipo Amazon, Costco)',
    'currentRatio.classic': '{{x}} — equilibrio clásico entre activo y pasivo corriente',
