 ...
 *
 * Pas de test bout-en-bout : getRatioTimeseries tape Finnhub + Yahoo + le store. On teste le
 * helper pur, qui porte toute la décision « ce point est du bruit → on ne le trace pas ». La
 * somme glissante et le garde-fou de définition, désormais partagés par les trois services de
 * graphes, sont testés dans intraYearStore.test.ts.
 */
