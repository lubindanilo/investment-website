...
const TICKER_TR: Record<ArticleLang, TickerTr> = {
  fr: {
    ...
    criteria: [
      "<strong>Rentable</strong> : marge nette &gt; 5 %",
      ...
      "<strong>CA par employé en progression</strong> : CA et CA par employé ≥ 10 %/an sur 5 ans ; validation partielle si un seul moteur atteint son palier (repli : marge de free cash flow &gt; 10 % si l'historique d'effectifs manque)",
  ...
  en: {
    ...
    criteria: [
      "<strong>Profitable</strong>: net margin &gt; 5%",
      ...
      "<strong>Growing revenue per employee</strong>: revenue and revenue per employee both grow ≥ 10%/year over 5 years; partial when only one growth driver reaches its tier (fallback: free cash flow margin &gt; 10% when employee history is unavailable)",
  ...
  es: {
    ...
    criteria: [
      "<strong>Rentable</strong>: margen neto &gt; 5%",
      ...
      "<strong>Ingresos por empleado en crecimiento</strong>: ingresos e ingresos por empleado crecen ≥ 10%/año en 5 años; parcial si solo un motor alcanza su tramo (alternativa: margen de free cash flow &gt; 10% si falta el historial de plantilla)",
...
${related.slice(0, 4).map((r) => {
  ...
  // Ressources : la liste ne contient plus que des cibles existantes (comparaison curee,
  // hub secteur). Les collections /classement/* sont retirees, remplacees par les landings.
  const resourceLinks = [
    compareLink,
    sectorHubHref ? `\n<a href="${sectorHubHref}">${tr.resSectorHub(sectorHubLabel || '')}</a>` : '',
  ].filter(Boolean);
...
const COMPARE_TR: Record<ArticleLang, CompareTr> = {
  ...
  en: {
    ...
    qualityBody: (hn, hs, ln, ls) => `${hn} passes ${hs} of our quality criteria, against ${ls} for ${ln}. The criteria are identical for both: profitability, revenue and free cash flow per share growth, share count control, revenue per employee growth, margin expansion, return on capital, debt, conversion of earnings into cash, and cash conversion cycle. No weighting, no opinion: it is a count.`,
    ...
    content: {
      fr: {
        ...
        sections: [
          ...
          { h2: 'Aller plus loin', p: 'Explorez le screener complet, les meilleures actions secteur par secteur, ou la méthodologie détaillée.' },
        ],
        links: [
      ...
      en: {
        ...
        sections: [
          ...
          { h2: 'Go further', p: 'Explore the full screener, the best stocks sector by sector, or the detailed methodology.' },
        ],
        links: [
      ...
      es: {
        ...
        sections: [
          ...
          { h2: 'Ir más lejos', p: 'Explora el screener completo, las mejores acciones sector por sector o la metodología detallada.' },
        ],
        links: [
  ...
  },
  {
    ...
    content: {
      fr: {
        ...
        links: [
          { href: '/palmares', label: 'Palmarès des opportunités repérées' },
      ...
      en: {
        ...
        links: [
          { href: '/palmares', label: 'Track record of spotted opportunities' },
      ...
      es: {
        ...
        links: [
          { href: '/palmares', label: 'Historial de oportunidades detectadas' },
  ...
  },
  {
    ...
    content: {
      fr: {
        ...
        sections: [
          { h2: 'Les 10 critères de qualité', p: "Rentabilité, croissance des ventes et du free cash flow, rachats d'actions, marges, évolution du CA par employé, rendement du capital (Cash ROCE), endettement maîtrisé, conversion du bénéfice en cash, cycle de trésorerie." },
        ...
        criteria: [
          { n: 1, name: '1. Rentable', formula: "Marge nette = Résultat net / Chiffre d'affaires", threshold: '> 5 %', why: "Une marge nette supérieure à 5 % valide pleinement le critère ; une marge positive jusqu'à 5 % reste partielle." },
          ...
          { n: 5, name: '5. CA par employé en progression', formula: "Croissances du chiffre d'affaires et du CA par employé sur 5 ans", threshold: 'CA et CA par employé ≥ 10 % par an', why: "Le critère est Oui si les deux croissances atteignent 10 %. Il est Partiel si le CA par employé atteint 10 % avec un CA inférieur à 10 %, ou si le CA atteint 10 % avec un CA par employé entre 5 % et 10 %. Le reste est Non. Quand l'historique d'effectifs n'est pas disponible, on note à la place la profitabilité cash." },
      ...
      en: {
        ...
        sections: [
          { h2: 'The 10 quality criteria', p: 'Profitability, growth in sales and free cash flow, share buybacks, margins, revenue per employee growth, return on capital (Cash ROCE), controlled debt, conversion of earnings into cash, cash cycle.' },
        ...
        criteria: [
          { n: 1, name: '1. Profitable', formula: 'Net margin = Net income / Revenue', threshold: '> 5%', why: 'A net margin above 5% fully passes the criterion; a positive margin up to 5% remains Partial.' },
          ...
          { n: 5, name: '5. Growing revenue per employee', formula: 'Revenue and revenue-per-employee growth over 5 years', threshold: 'Revenue and revenue per employee ≥ 10% per year', why: 'The criterion is Yes when both growth rates reach 10%. It is Partial when revenue per employee reaches 10% with revenue below 10%, or when revenue reaches 10% with revenue per employee between 5% and 10%. Everything else is No. When employee history is unavailable, we grade cash profitability instead.' },
      ...
      es: {
        ...
        sections: [
          { h2: 'Los 10 criterios de calidad', p: 'Rentabilidad, crecimiento de las ventas y del free cash flow, recompras de acciones, márgenes, evolución de los ingresos por empleado, rendimiento del capital (Cash ROCE), endeudamiento controlado, conversión del beneficio en efectivo, ciclo de tesorería.' },
        ...
        criteria: [
          { n: 1, name: '1. Rentable', formula: 'Margen neto = Beneficio neto / Ingresos', threshold: '> 5 %', why: 'Un margen neto superior al 5% valida plenamente el criterio; un margen positivo hasta el 5% queda en Parcial.' },
          ...
          { n: 5, name: '5. Ingresos por empleado en crecimiento', formula: 'Crecimiento de ingresos e ingresos por empleado en 5 años', threshold: 'Ingresos e ingresos por empleado ≥ 10% al año', why: 'El criterio es Sí cuando ambos crecimientos alcanzan el 10%. Es Parcial si los ingresos por empleado alcanzan el 10% con ingresos inferiores al 10%, o si los ingresos alcanzan el 10% con ingresos por empleado entre el 5% y el 10%. El resto es No. Cuando falta el historial de plantilla, puntuamos la rentabilidad de caja.' },
    ...
    content: {
      ...
      en: {
        ...
        sections: [
          ...
          { h2: 'What does the score out of 10 mean?', p: "It is the number of quality criteria passed out of 10, each tested against a threshold drawn from the financial literature (profitability, revenue and free cash flow per share growth, buybacks, revenue per employee growth, operating leverage, Cash ROCE, net debt to FCF, cash conversion, cash conversion cycle). A score of 8 out of 10 means 8 criteria are passed." },
      ...
      es: {
        ...
        sections: [
          ...
          { h2: '¿Qué significa la nota sobre 10?', p: "Es el número de criterios de calidad validados sobre 10, cada uno comparado con un umbral sacado de la literatura financiera (rentabilidad, crecimiento de los ingresos y del free cash flow por acción, recompras, evolución de los ingresos por empleado, apalancamiento operativo, Cash ROCE, deuda neta sobre FCF, conversión del cash, ciclo de tesorería). Una nota de 8 sobre 10 significa que se validan 8 criterios." },
