...
const TICKER_TR: Record<ArticleLang, TickerTr> = {
  fr: {
    ...
    criteria: [
      ...
      "<strong>CA par employé en progression</strong> : chiffre d'affaires par employé &gt; 5 %/an sur 5 ans (repli : marge de free cash flow &gt; 10 % si l'historique d'effectifs manque)",
  ...
  en: {
    ...
    criteria: [
      ...
      "<strong>Growing revenue per employee</strong>: revenue per employee growing &gt; 5%/year over 5 years (fallback: free cash flow margin &gt; 10% when employee history is unavailable)",
  ...
  es: {
    ...
    criteria: [
      ...
      "<strong>Ingresos por empleado en crecimiento</strong>: ingresos por empleado &gt; 5%/año en 5 años (alternativa: margen de free cash flow &gt; 10% si falta el historial de plantilla)",
    ...
    content: {
      fr: {
        ...
        criteria: [
          ...
          { n: 5, name: '5. CA par employé en progression', formula: "Chiffre d'affaires annuel / nombre d'employés, évolution sur 5 ans", threshold: '> 5 % par an', why: "Faire plus de ventes avec la même équipe, c'est le signe d'une organisation qui gagne en efficacité : automatisation, pricing power, effet d'échelle. Quand l'historique d'effectifs n'est pas disponible, on note à la place la profitabilité cash (free cash flow / chiffre d'affaires, seuil 10 %)." },
      ...
      en: {
        ...
        criteria: [
          ...
          { n: 5, name: '5. Growing revenue per employee', formula: 'Annual revenue / number of employees, trend over 5 years', threshold: '> 5% per year', why: 'Generating more sales with the same team is the mark of an organization getting more efficient: automation, pricing power, economies of scale. When employee history is unavailable, we grade cash profitability instead (free cash flow / revenue, 10% threshold).' },
      ...
      es: {
        ...
        criteria: [
          ...
          { n: 5, name: '5. Ingresos por empleado en crecimiento', formula: 'Ingresos anuales / número de empleados, tendencia a 5 años', threshold: '> 5 % al año', why: 'Generar más ventas con el mismo equipo es la marca de una organización que gana en eficiencia: automatización, poder de fijación de precios, economías de escala. Cuando falta el historial de plantilla, puntuamos en su lugar la rentabilidad de caja (free cash flow / ingresos, umbral del 10 %).' },
