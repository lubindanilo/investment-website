...
const AUTHOR_BIO: Record<ArticleLang, string> = {
  fr: "Écrit par Lubin Danilo, fondateur de Lubin Investment. Investisseur particulier autodidacte, l'analyse fondamentale me passionne et donne de superbes résultats. Mais analyser chaque action me prenait trop de temps : des sites aux données incomplètes, des méthodes de calcul et des critères jamais alignés sur les miens. Repérer les pépites était tout aussi chronophage, même avec ma liste de critères bien définie. J'ai donc mis mon expérience de développeur à profit pour créer cet outil, l'appliquer à mon propre argent et en faire profiter tout le monde. Il juge séparément la qualité d'un business et son prix, à partir de critères inspirés de la littérature financière (Warren Buffett, Michael Mauboussin, Aswath Damodaran).",
  en: "Written by Lubin Danilo, founder of Lubin Investment. A self-taught individual investor, I find fundamental analysis fascinating and it delivers great results. But analyzing every stock took too much time: sites with incomplete data, calculation methods and criteria never aligned with mine. Spotting the gems was just as time-consuming, even with my own well-defined checklist. So I put my developer background to work to build this tool, apply it to my own money, and make it public for everyone. It judges a company's quality and its price separately, using criteria drawn from the financial literature (Warren Buffett, Michael Mauboussin, Aswath Damodaran).",
  es: "Escrito por Lubin Danilo, fundador de Lubin Investment. Inversor particular autodidacta, el análisis fundamental me apasiona y da resultados excelentes. Pero analizar cada acción me llevaba demasiado tiempo: sitios con datos incompletos, métodos de cálculo y criterios nunca alineados con los míos. Detectar las joyas era igual de laborioso, incluso con mi lista de criterios bien definida. Por eso aproveché mi experiencia como desarrollador para crear esta herramienta, aplicarla a mi propio dinero y compartirla con todos. Juzga por separado la calidad de un negocio y su precio, con criterios inspirados en la literatura financiera (Warren Buffett, Michael Mauboussin, Aswath Damodaran).",
};
