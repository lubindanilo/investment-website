...
const palmares14: Article = {
  slug: '14-actions-10-10-sous-evaluees-juin-2026',
  date: '2026-06-10',
  updated: '2026-06-10',
  readingTime: 10,
  content: {
    fr: {
      title: '14 actions 10/10 sous-évaluées en juin 2026',
      excerpt:
        "14 entreprises notées 10/10 sur la qualité qui se paient bon marché. Mon classement complet, avec les P/FCF et une analyse des dossiers les plus frappants.",
      metaDescription:
        "14 actions notées 10/10 sur la qualité financière, avec un P/FCF bas. Classement complet, tableau comparatif, mini-analyses de GDDY, KNSL, CRM, ROP.",
      answer:
        "En juin 2026, 14 entreprises valident mes 10 critères de qualité tout en se payant à un P/FCF inférieur à la moyenne du marché. Parmi elles, Kinsale Capital à 7,0 fois son cash, GoDaddy à 8,4 fois ou Salesforce à 13,2 fois. Ce sont des entreprises d'élite qui se paient bon marché : le croisement rare entre la qualité du business et le prix de l'action.",
      body: [
        { type: 'ul', items: [
          "14 entreprises notées 10/10 sur la qualité se paient sous-évaluées en juin 2026.",
          "Note 10/10 : l'entreprise valide tous mes critères fondamentaux (rentabilité, croissance du cash, bilan sain). Rien à voir avec le prix.",
          "Sous-évaluée : le P/FCF (prix rapporté au cash généré) est bas, synonyme de bon marché.",
          "Qualité d'abord, prix ensuite : je juge toujours les deux séparément.",
          "Tableau complet des 14 actions, avec leurs secteurs et leurs P/FCF.",
        ] },
        { type: 'h2', text: 'Pourquoi je sépare toujours la qualité du prix' },
        { type: 'p', text: "La plupart des gens mélangent deux questions qui n'ont rien à voir. Est-ce une bonne entreprise ? Est-ce le bon prix ? Mélanger les deux, c'est la source d'erreur numéro un en investissement. Une entreprise géniale payée trop cher reste un mauvais placement. Une entreprise médiocre bradée reste médiocre." },
        { type: 'p', text: "C'est pourquoi j'ai construit ma propre méthode : je juge la qualité d'un business sur 10 critères financiers objectifs, sans regarder le prix. Je lui donne une note sur 10. Puis, séparément, je regarde si le prix est raisonnable. Une note de 10/10 ne veut pas dire qu'il faut acheter : elle veut dire que le business est sain. La décision finale dépend du prix." },
        { type: 'p', text: "Pour mesurer le prix, j'utilise le P/FCF (price to free cash flow). Le free cash flow, c'est l'argent qui reste vraiment dans les caisses une fois toutes les factures payées : salaires, machines, impôts. Le P/FCF, c'est le prix de l'action divisé par ce cash annuel. Un P/FCF bas veut dire que tu paies peu pour le cash que l'entreprise génère : l'action se paie bon marché. Le sens du ratio d'abord : P/FCF bas = bon marché." },
        { type: 'h2', text: 'Le tableau des 14 actions 10/10 sous-évaluées' },
        { type: 'p', text: "Voici les 14 entreprises qui allient une note qualité parfaite (10/10) et un P/FCF bas. Le secteur est indiqué pour chaque ligne." },
        { type: 'p', text: "Le tableau ci-dessous résume les 14 actions. Tu peux cliquer sur un ticker pour voir l'analyse complète, ou parcourir le classement complet des actions sous-évaluées." },
        { type: 'p', text: "Note qualité /10 | Ticker | Entreprise | P/FCF | Secteur" },
        { type: 'p', text: "10/10 | INTU | Intuit | 14,2× | Logiciels financiers" },
        { type: 'p', text: "10/10 | QLYS | Qualys | 18,2× | Cybersécurité" },
        { type: 'p', text: "10/10 | BKNG | Booking Holdings | N/C | Voyage en ligne" },
        { type: 'p', text: "10/10 | ROP | Roper Technologies | 13,8× | Logiciels industriels" },
        { type: 'p', text: "10/10 | CRM | Salesforce | 13,2× | Logiciels d'entreprise" },
        { type: 'p', text: "10/10 | MELI | MercadoLibre | N/C | Commerce en ligne" },
        { type: 'p', text: "10/10 | KNSL | Kinsale Capital | 7,0× | Assurance spécialisée" },
        { type: 'p', text: "10/10 | GDDY | GoDaddy | 8,4× | Hébergement web" },
        { type: 'p', text: "10/10 | HAE | Haemonetics | N/C | Technologies médicales" },
        { type: 'p', text: "10/10 | DOCS | Doximity | 18,4× | Santé numérique" },
        { type: 'p', text: "10/10 | MCY | Mercury General | N/C | Assurance" },
        { type: 'p', text: "10/10 | RNR | RenaissanceRe | N/C | Réassurance" },
        { type: 'p', text: "10/10 | PCTY | Paylocity | 17,6× | Paie et RH" },
        { type: 'p', text: "10/10 | ERIE | Erie Indemnity | N/C | Assurance" },
        { type: 'ul', items: [
          "Le P/FCF est indiqué quand je le connais. Pour les autres, tu peux le retrouver sur la page d'analyse de chaque ticker.",
          "Les secteurs montrent une diversité : logiciels, assurance, santé, e-commerce.",
          "Clique sur n'importe quel ticker pour l'analyse complète sur la page /analyser.",
        ] },
        { type: 'h2', text: 'Analyse de 4 dossiers frappants' },
        { type: 'p', text: "Parmi ces 14 actions, quatre retiennent particulièrement mon attention cette semaine. Je détaille pourquoi." },
        { type: 'h2', text: 'GoDaddy (GDDY) : un P/FCF de 8,4× pour un leader de l\'hébergement' },
        { type: 'p', text: "GoDaddy est un éditeur de logiciels d'hébergement web qui a discrètement construit l'une des machines à cash les plus régulières du secteur. Il se paie bon marché : un P/FCF de 8,4 fois. Le sens d'abord : un P/FCF de 8,4, c'est bon marché pour une entreprise de qualité 10/10." },
        { type: 'p', text: "Le free cash flow, c'est l'argent qui reste vraiment dans les caisses une fois toutes les factures payées. Quand GoDaddy génère 100 dollars de cash, tu paies 840 dollars pour l'action. À titre de comparaison, le secteur du logiciel se paie souvent entre 20 et 40 fois son cash. Un P/FCF de 8,4 veut dire que le marché traite GoDaddy comme une entreprise ordinaire, alors que sa qualité est maximale. C'est typiquement le genre d'écart que je cherche : une qualité reconnue par mes critères, mais pas encore par le marché." },
        { type: 'p', text: "Tu peux analyser GoDaddy en détail sur la page d'analyse, ou le comparer à d'autres valeurs du classement." },
        { type: 'h2', text: "Kinsale Capital (KNSL) : l'assureur 10/10 à 7,0×, l'un des cash les moins chers" },
        { type: 'p', text: "Kinsale Capital est un assureur spécialisé qui couvre les risques atypiques que personne ne veut toucher (food trucks, parcs d'attractions, drones). Sa note 10/10 vient d'une rentabilité exceptionnelle : 52 % de marge de free cash flow, une croissance de 33 % par an, un bilan sans dette nette." },
        { type: 'p', text: "Avec un P/FCF de 7,0 fois, Kinsale se paie bon marché : tu paies sept années de son cash. Le sens du ratio d'abord : un P/FCF de 7,0, c'est bon marché, surtout pour une entreprise qui grandit de 33 % par an. La médiane du secteur de l'assurance tourne à 7,4 fois, et Kinsale croît deux à trois fois plus vite que ses concurrents. Normalement, on paie une prime pour une telle croissance. Ici, le marché applique une décote. L'article complet sur Kinsale Capital plonge dans le détail de la valorisation." },
        { type: 'h2', text: "Salesforce (CRM) : le géant du CRM à 13,2×, pas cher pour son histoire" },
        { type: 'p', text: "Salesforce est le leader mondial des logiciels de gestion de la relation client (CRM). Il valide mes 10 critères de qualité, avec une marge de free cash flow solide et une croissance régulière. Son P/FCF de 13,2 le range dans le bon marché pour un éditeur de logiciels de cette taille." },
        { type: 'p', text: "Un P/FCF de 13,2, c'est bon marché pour Salesforce : le logiciel d'entreprise se paie souvent beaucoup plus cher. Le marché a peut-être peur de la maturité du marché du CRM, ou de la pression concurrentielle de Microsoft Dynamics. Mais une entreprise de qualité 10/10 à 13,2 fois son cash, c'est exactement le type de profil que je surveille. Tu peux l'analyser sur /analyser/CRM." },
        { type: 'h2', text: "Roper Technologies (ROP) : un conglomérat de niche à 13,8×" },
        { type: 'p', text: "Roper Technologies est un cas à part. C'est un conglomérat qui achète et gère des entreprises de logiciels et de technologies dans des niches très spécifiques : logiciels pour hôpitaux, pour la gestion de l'eau, pour l'éducation. Chaque filiale est un petit monopole dans son coin." },
        { type: 'p', text: "Son P/FCF de 13,8 fois, c'est bon marché pour Roper. L'entreprise a la réputation d'acheter cher et de bien gérer, ce qui se traduit d'habitude par un multiple élevé. Le fait qu'elle se paie à 13,8 fois son cash aujourd'hui est inhabituel. C'est peut-être dû à la rotation des investisseurs vers des secteurs plus simples. Dans tous les cas, une qualité 10/10 à ce prix mérite un coup d'œil. Compare Roper avec d'autres conglomérats sur la page de comparaison." },
        { type: 'h2', text: 'Ce que j\'en retiens : la qualité pas chère existe, mais elle est rare' },
        { type: 'p', text: "Ces 14 actions sont la preuve que la qualité pas chère existe. Mais elle ne tombe pas toute seule : il faut un outil pour la trouver. C'est précisément pourquoi j'ai construit mon screener, qui croise la note qualité avec le P/FCF pour chaque action suivie. Le screener complet te permet de filtrer par secteur, par note, et par multiple de valorisation." },
        { type: 'p', text: "La leçon est simple. Ne cherche pas le pas cher : cherche la qualité pas chère. Juge l'entreprise d'abord (est-elle rentable, croît-elle, a-t-elle un bilan sain ?). Puis juge le prix (le P/FCF est-il bas ?). Les deux ensemble sont rares. Quand tu les trouves, tu tiens quelque chose." },
        { type: 'p', text: "Tu peux retrouver la liste complète et mise à jour en continu sur la page des actions sous-évaluées, analyser n'importe quel ticker sur /analyser, ou filtrer toi-même sur le screener. La qualité d'abord, le prix ensuite : c'est tout ce que j'ai voulu pouvoir faire, alors je l'ai construit." },
      ],
      faq: [
        { q: "C'est quoi, la note 10/10 ?", a: "C'est ma note de qualité sur 10, basée sur 10 critères financiers objectifs : rentabilité, croissance des ventes et du cash, rachats d'actions, endettement maîtrisé, rendement du capital. Elle juge la solidité du business, indépendamment du prix de l'action. Une note de 10/10 ne veut pas dire qu'il faut acheter : le prix compte aussi." },
        { q: "C'est quoi le P/FCF, en clair ?", a: "Le P/FCF (price to free cash flow) rapporte le prix de l'action au free cash flow qu'elle génère chaque année. Le free cash flow, c'est l'argent qui reste vraiment une fois toutes les factures payées. Un P/FCF de 8,4 veut dire que tu paies 8,4 années de ce cash : plus c'est bas, plus l'action se paie bon marché." },
        { q: "Pourquoi certaines actions n'ont-elles pas de P/FCF dans le tableau ?", a: "Je n'indique que les P/FCF dont je suis certain. Pour ceux qui manquent, tu peux les retrouver sur la page d'analyse de chaque ticker, ou dans le classement complet des actions sous-évaluées mis à jour en continu." },
        { q: "Est-ce qu'une note 10/10 et un P/FCF bas garantissent un bon investissement ?", a: "Non. Une note 10/10 mesure la qualité du business aujourd'hui, et un P/FCF bas dit que le prix est bon marché. Mais l'avenir peut tout changer : une entreprise peut se dégrader, un secteur peut se retourner. Ce croisement donne une base solide, pas une certitude. Ce n'est pas un conseil en investissement." },
        { q: "Comment trouver ces actions moi-même ?", a: "Tu peux utiliser mon screener, qui croise la note qualité et le P/FCF pour des centaines d'actions. Tu peux aussi parcourir le classement des actions sous-évaluées ou analyser un ticker en particulier sur la page d'analyse." },
      ],
      tags: ['Classement', '10/10', 'Sous-évaluées', 'P/FCF', 'Analyse'],
      disclaimer:
        "Cet article est une analyse à but informatif et éducatif et ne constitue pas un conseil en investissement personnalisé. Les performances passées ne préjugent pas des performances futures. Chiffres au 10 juin 2026, susceptibles d'évoluer. Fais tes propres recherches.",
    },
    en: {
      title: '14 undervalued 10/10 stocks in June 2026',
      excerpt:
        "14 companies rated 10/10 on quality that trade cheap. My complete ranking, with P/FCF ratios and analysis of the most striking cases.",
      metaDescription:
        "14 stocks rated 10/10 on financial quality, with a low P/FCF. Full ranking, comparison table, mini-analyses of GDDY, KNSL, CRM, ROP.",
      answer:
        "In June 2026, 14 companies pass all my 10 quality criteria while trading at a P/FCF below the market average. Among them, Kinsale Capital at 7.0 times its cash, GoDaddy at 8.4 times, or Salesforce at 13.2 times. These are elite businesses trading cheap: the rare crossover between business quality and stock price.",
      body: [
        { type: 'ul', items: [
          "14 companies rated 10/10 on quality trade undervalued in June 2026.",
          "Score 10/10: the company passes all my fundamental criteria (profitability, cash growth, sound balance sheet). Nothing to do with price.",
          "Undervalued: the P/FCF (price to free cash flow) is low, meaning it trades cheap.",
          "Quality first, price second: I always judge the two separately.",
          "Complete table of all 14 stocks, with sectors and P/FCF ratios.",
        ] },
        { type: 'h2', text: 'Why I always separate quality from price' },
        { type: 'p', text: "Most people mix up two questions that have nothing to do with each other. Is it a good company? Is it the right price? Mixing the two is the number one source of error in investing. A great company bought too expensive is still a bad investment. A mediocre company, even dirt cheap, stays mediocre." },
        { type: 'p', text: "That is why I built my own method: I judge a business's quality on 10 objective financial criteria, without looking at the price. I give it a score out of 10. Then, separately, I check whether the price is reasonable. A 10/10 score does not mean you should buy: it means the business is sound. The final decision depends on the price." },
        { type: 'p', text: "To measure price, I use the P/FCF (price to free cash flow). Free cash flow is the money that actually stays in the bank once every bill is paid: salaries, machines, taxes. The P/FCF is the share price divided by that yearly cash. A low P/FCF means you pay little for the cash the company generates: the stock trades cheap. Meaning of the ratio first: low P/FCF = cheap." },
        { type: 'h2', text: 'The table of 14 undervalued 10/10 stocks' },
        { type: 'p', text: "Here are the 14 companies that combine a perfect quality score (10/10) with a low P/FCF. The sector is shown for each line." },
        { type: 'p', text: "The table below summarizes all 14 stocks. Click any ticker for the full analysis, or browse the complete ranking of undervalued stocks." },
        { type: 'p', text: "Quality score /10 | Ticker | Company | P/FCF | Sector" },
        { type: 'p', text: "10/10 | INTU | Intuit | 14.2x | Financial software" },
        { type: 'p', text: "10/10 | QLYS | Qualys | 18.2x | Cybersecurity" },
        { type: 'p', text: "10/10 | BKNG | Booking Holdings | N/C | Online travel" },
        { type: 'p', text: "10/10 | ROP | Roper Technologies | 13.8x | Industrial software" },
        { type: 'p', text: "10/10 | CRM | Salesforce | 13.2x | Enterprise software" },
        { type: 'p', text: "10/10 | MELI | MercadoLibre | N/C | E-commerce" },
        { type: 'p', text: "10/10 | KNSL | Kinsale Capital | 7.0x | Specialty insurance" },
        { type: 'p', text: "10/10 | GDDY | GoDaddy | 8.4x | Web hosting" },
        { type: 'p', text: "10/10 | HAE | Haemonetics | N/C | Medical technology" },
        { type: 'p', text: "10/10 | DOCS | Doximity | 18.4x | Digital health" },
        { type: 'p', text: "10/10 | MCY | Mercury General | N/C | Insurance" },
        { type: 'p', text: "10/10 | RNR | RenaissanceRe | N/C | Reinsurance" },
        { type: 'p', text: "10/10 | PCTY | Paylocity | 17.6x | Payroll and HR" },
        { type: 'p', text: "10/10 | ERIE | Erie Indemnity | N/C | Insurance" },
        { type: 'ul', items: [
          "The P/FCF is shown when I know it. For others, you can find it on each ticker's analysis page.",
          "Sectors show diversity: software, insurance, healthcare, e-commerce.",
          "Click any ticker for the full analysis on the /analyze page.",
        ] },
        { type: 'h2', text: 'Analysis of 4 striking cases' },
        { type: 'p', text: "Among these 14 stocks, four particularly catch my attention this week. Here is why." },
        { type: 'h2', text: 'GoDaddy (GDDY) : a P/FCF of 8.4x for a hosting leader' },
        { type: 'p', text: "GoDaddy is a web hosting software company that has quietly built one of the most consistent cash machines in the sector. It trades cheap: a P/FCF of 8.4 times. Meaning first: a P/FCF of 8.4 is cheap for a 10/10 quality company." },
        { type: 'p', text: "Free cash flow is the money that truly remains in the bank once every bill is paid. When GoDaddy generates 100 dollars of cash, you pay 840 dollars for the stock. For comparison, the software sector often trades between 20 and 40 times its cash. A P/FCF of 8.4 means the market treats GoDaddy like an ordinary company, even though its quality is maximal. This is exactly the kind of gap I look for: quality recognized by my criteria, but not yet by the market." },
        { type: 'p', text: "You can analyze GoDaddy in detail on the analysis page, or compare it to other names in the ranking." },
        { type: 'h2', text: "Kinsale Capital (KNSL) : the 10/10 insurer at 7.0x, one of the cheapest cash multiples" },
        { type: 'p', text: "Kinsale Capital is a specialty insurer covering the unusual risks nobody else wants (food trucks, amusement parks, drones). Its 10/10 score comes from exceptional profitability: a 52% free cash flow margin, 33% annual growth, a balance sheet with no net debt." },
        { type: 'p', text: "At 7.0 times its cash, Kinsale trades cheap: you pay seven years of its cash. Meaning of the ratio first: a P/FCF of 7.0 is cheap, especially for a company growing 33% a year. The insurance sector median sits at 7.4 times, and Kinsale grows two to three times faster than its competitors. Normally you pay a premium for such growth. Here the market applies a discount. The full article on Kinsale Capital dives deeper into the valuation." },
        { type: 'h2', text: "Salesforce (CRM) : the CRM giant at 13.2x, cheap for its story" },
        { type: 'p', text: "Salesforce is the global leader in customer relationship management (CRM) software. It passes my 10 quality criteria, with a solid free cash flow margin and steady growth. Its P/FCF of 13.2 puts it in the cheap range for an enterprise software company of this size." },
        { type: 'p', text: "A P/FCF of 13.2, that is cheap for Salesforce: enterprise software usually trades much higher. The market may fear the CRM market's maturity, or competitive pressure from Microsoft Dynamics. But a 10/10 quality company at 13.2 times its cash is exactly the kind of profile I watch. You can analyze it at /analyze/CRM." },
        { type: 'h2', text: "Roper Technologies (ROP) : a niche conglomerate at 13.8x" },
        { type: 'p', text: "Roper Technologies is a different case. It is a conglomerate that buys and manages software and technology companies in very specific niches: hospital software, water management, education. Each subsidiary is a small monopoly in its corner." },
        { type: 'p', text: "A P/FCF of 13.8 is cheap for Roper. The company is known for buying well and managing well, which usually commands a high multiple. That it trades at 13.8 times its cash today is unusual. It might be due to the investor rotation toward simpler sectors. In any case, a 10/10 quality at this price deserves a look. Compare Roper with other conglomerates on the comparison page." },
        { type: 'h2', text: 'What I take away : quality on the cheap exists, but it is rare' },
        { type: 'p', text: "These 14 stocks prove that quality on the cheap does exist. But it does not fall into your lap: you need a tool to find it. That is precisely why I built my screener, which crosses the quality score with the P/FCF for every stock I track. The full screener lets you filter by sector, by score, and by valuation multiple." },
        { type: 'p', text: "The lesson is simple. Do not chase cheap: chase quality on the cheap. Judge the company first (is it profitable, is it growing, does it have a sound balance sheet?). Then judge the price (is the P/FCF low?). Both together are rare. When you find them, you have something." },
        { type: 'p', text: "You can find the full, continuously updated list on the undervalued stocks page, analyze any ticker at /analyze, or filter yourself on the screener. Quality first, price second: that is all I ever wanted to be able to do, so I built it." },
      ],
      faq: [
        { q: 'What is the 10/10 score?', a: "It is my quality score out of 10, based on 10 objective financial criteria: profitability, sales and cash growth, share buybacks, debt control, return on capital. It judges the soundness of the business, regardless of the stock price. A 10/10 score does not mean you should buy: price matters too." },
        { q: 'What is P/FCF in plain terms?', a: "The P/FCF (price to free cash flow) compares the share price to the free cash flow it generates each year. Free cash flow is the money truly left once every bill is paid. A P/FCF of 8.4 means you pay 8.4 years of that cash: the lower it is, the cheaper the stock trades." },
        { q: 'Why do some stocks have no P/FCF in the table?', a: "I only show the P/FCF values I am certain of. For the missing ones, you can find them on each ticker's analysis page, or in the continuously updated full ranking of undervalued stocks." },
        { q: 'Does a 10/10 score and a low P/FCF guarantee a good investment?', a: "No. A 10/10 score measures the business's quality today, and a low P/FCF says the price is cheap. But the future can change everything: a company can deteriorate, a sector can turn. This crossover gives a solid foundation, not a certainty. This is not investment advice." },
        { q: 'How can I find these stocks myself?', a: "You can use my screener, which crosses the quality score and the P/FCF for hundreds of stocks. You can also browse the ranking of undervalued stocks or analyze a specific ticker on the analysis page." },
      ],
      tags: ['Ranking', '10/10', 'Undervalued', 'P/FCF', 'Analysis'],
      disclaimer:
        'This article is an analysis for informational and educational purposes and is not personalized investment advice. Past performance does not guarantee future results. Figures as of June 10, 2026, subject to change. Do your own research.',
    },
    es: {
      title: '14 acciones 10/10 infravaloradas en junio 2026',
      excerpt:
        '14 empresas puntuadas 10/10 en calidad que cotizan baratas. Mi clasificación completa, con los P/FCF y análisis de los casos más llamativos.',
      metaDescription:
        '14 acciones puntuadas 10/10 en calidad financiera, con un P/FCF bajo. Clasificación completa, tabla comparativa, minianálisis de GDDY, KNSL, CRM, ROP.',
      answer:
        'En junio 2026, 14 empresas validan mis 10 criterios de calidad mientras cotizan a un P/FCF inferior a la media del mercado. Entre ellas, Kinsale Capital a 7,0 veces su caja, GoDaddy a 8,4 veces o Salesforce a 13,2 veces. Son negocios de élite que cotizan baratos: el cruce poco común entre la calidad del negocio y el precio de la acción.',
      body: [
        { type: 'ul', items: [
          '14 empresas puntuadas 10/10 en calidad cotizan infravaloradas en junio 2026.',
          'Nota 10/10: la empresa valida todos mis criterios fundamentales (rentabilidad, crecimiento de caja, balance sano). Nada que ver con el precio.',
          'Infravalorada: el P/FCF (precio respecto a la caja generada) es bajo, sinónimo de barato.',
          'Calidad primero, precio después: siempre juzgo los dos por separado.',
          'Tabla completa de las 14 acciones, con sus sectores y sus P/FCF.',
        ] },
        { type: 'h2', text: 'Por qué separo siempre la calidad del precio' },
        { type: 'p', text: 'La mayoría de la gente mezcla dos preguntas que no tienen nada que ver. ¿Es una buena empresa? ¿Es el precio correcto? Mezclarlas es la fuente de error número uno en inversión. Una empresa genial comprada demasiado cara sigue siendo una mala inversión. Una empresa mediocre, incluso tirada de precio, sigue siendo mediocre.' },
        { type: 'p', text: 'Por eso construí mi propio método: juzgo la calidad de un negocio con 10 criterios financieros objetivos, sin mirar el precio. Le doy una nota sobre 10. Luego, por separado, miro si el precio es razonable. Una nota 10/10 no significa que haya que comprar: significa que el negocio es sólido. La decisión final depende del precio.' },
        { type: 'p', text: 'Para medir el precio, uso el P/FCF (price to free cash flow). El free cash flow es el dinero que de verdad queda en caja una vez pagadas todas las facturas: salarios, máquinas, impuestos. El P/FCF es el precio de la acción dividido por esa caja anual. Un P/FCF bajo significa que pagas poco por la caja que la empresa genera: la acción cotiza barata. El sentido del ratio primero: P/FCF bajo = barato.' },
        { type: 'h2', text: 'La tabla de las 14 acciones 10/10 infravaloradas' },
        { type: 'p', text: 'Aquí están las 14 empresas que combinan una puntuación de calidad perfecta (10/10) con un P/FCF bajo. El sector se indica para cada línea.' },
        { type: 'p', text: 'La tabla siguiente resume las 14 acciones. Haz clic en un ticker para ver el análisis completo, o recorre la clasificación completa de acciones infravaloradas.' },
        { type: 'p', text: 'Nota calidad /10 | Ticker | Empresa | P/FCF | Sector' },
        { type: 'p', text: '10/10 | INTU | Intuit | 14,2× | Software financiero' },
        { type: 'p', text: '10/10 | QLYS | Qualys | 18,2× | Ciberseguridad' },
        { type: 'p', text: '10/10 | BKNG | Booking Holdings | N/C | Viajes en línea' },
        { type: 'p', text: '10/10 | ROP | Roper Technologies | 13,8× | Software industrial' },
        { type: 'p', text: '10/10 | CRM | Salesforce | 13,2× | Software empresarial' },
        { type: 'p', text: '10/10 | MELI | MercadoLibre | N/C | Comercio electrónico' },
        { type: 'p', text: '10/10 | KNSL | Kinsale Capital | 7,0× | Seguros especializados' },
        { type: 'p', text: '10/10 | GDDY | GoDaddy | 8,4× | Alojamiento web' },
        { type: 'p', text: '10/10 | HAE | Haemonetics | N/C | Tecnología médica' },
        { type: 'p', text: '10/10 | DOCS | Doximity | 18,4× | Salud digital' },
        { type: 'p', text: '10/10 | MCY | Mercury General | N/C | Seguros' },
        { type: 'p', text: '10/10 | RNR | RenaissanceRe | N/C | Reaseguros' },
        { type: 'p', text: '10/10 | PCTY | Paylocity | 17,6× | Nóminas y RRHH' },
        { type: 'p', text: '10/10 | ERIE | Erie Indemnity | N/C | Seguros' },
        { type: 'ul', items: [
          'El P/FCF se muestra cuando lo conozco. Para los demás, puedes encontrarlo en la página de análisis de cada ticker.',
          'Los sectores muestran diversidad: software, seguros, salud, comercio electrónico.',
          'Haz clic en cualquier ticker para el análisis completo en la página /analizar.',
        ] },
        { type: 'h2', text: 'Análisis de 4 casos llamativos' },
        { type: 'p', text: 'Entre estas 14 acciones, cuatro llaman especialmente mi atención esta semana. Detallo por qué.' },
        { type: 'h2', text: 'GoDaddy (GDDY) : un P/FCF de 8,4× para un líder del alojamiento' },
        { type: 'p', text: 'GoDaddy es una empresa de software de alojamiento web que ha construido discretamente una de las máquinas de caja más regulares del sector. Cotiza barata: un P/FCF de 8,4 veces. El sentido primero: un P/FCF de 8,4 es barato para una empresa de calidad 10/10.' },
        { type: 'p', text: 'El free cash flow es el dinero que de verdad queda en caja una vez pagadas todas las facturas. Cuando GoDaddy genera 100 dólares de caja, pagas 840 dólares por la acción. En comparación, el sector del software suele cotizar entre 20 y 40 veces su caja. Un P/FCF de 8,4 significa que el mercado trata a GoDaddy como una empresa corriente, aunque su calidad es máxima. Es exactamente el tipo de brecha que busco: calidad reconocida por mis criterios, pero aún no por el mercado.' },
        { type: 'p', text: 'Puedes analizar GoDaddy en detalle en la página de análisis, o compararlo con otros valores de la clasificación.' },
        { type: 'h2', text: 'Kinsale Capital (KNSL) : la aseguradora 10/10 a 7,0×, una de las cajas más baratas' },
        { type: 'p', text: 'Kinsale Capital es una aseguradora especializada que cubre los riesgos atípicos que nadie más quiere (food trucks, parques de atracciones, drones). Su nota 10/10 viene de una rentabilidad excepcional: 52 % de margen de free cash flow, un crecimiento del 33 % anual, un balance sin deuda neta.' },
        { type: 'p', text: 'A 7,0 veces su caja, Kinsale cotiza barata: pagas siete años de su caja. El sentido del ratio primero: un P/FCF de 7,0 es barato, especialmente para una empresa que crece al 33 % anual. La mediana del sector de seguros ronda las 7,4 veces, y Kinsale crece dos o tres veces más rápido que sus competidores. Normalmente se paga una prima por ese crecimiento. Aquí el mercado aplica un descuento. El artículo completo sobre Kinsale Capital profundiza en la valoración.' },
        { type: 'h2', text: 'Salesforce (CRM) : el gigante del CRM a 13,2×, barato para su historia' },
        { type: 'p', text: 'Salesforce es el líder mundial en software de gestión de relaciones con clientes (CRM). Valida mis 10 criterios de calidad, con un margen de free cash flow sólido y un crecimiento constante. Su P/FCF de 13,2 lo sitúa en rango barato para una empresa de software empresarial de este tamaño.' },
        { type: 'p', text: 'Un P/FCF de 13,2 es barato para Salesforce: el software empresarial suele cotizar mucho más caro. El mercado puede temer la madurez del mercado del CRM o la presión competitiva de Microsoft Dynamics. Pero una empresa de calidad 10/10 a 13,2 veces su caja es exactamente el tipo de perfil que vigilo. Puedes analizarla en /analizar/CRM.' },
        { type: 'h2', text: 'Roper Technologies (ROP) : un conglomerado de nicho a 13,8×' },
        { type: 'p', text: 'Roper Technologies es un caso aparte. Es un conglomerado que compra y gestiona empresas de software y tecnología en nichos muy específicos: software hospitalario, gestión del agua, educación. Cada filial es un pequeño monopolio en su rincón.' },
        { type: 'p', text: 'Un P/FCF de 13,8 es barato para Roper. La empresa tiene fama de comprar bien y gestionar bien, lo que suele traducirse en un múltiplo alto. Que cotice a 13,8 veces su caja hoy es inusual. Quizá se deba a la rotación de los inversores hacia sectores más simples. En cualquier caso, una calidad 10/10 a este precio merece un vistazo. Compara Roper con otros conglomerados en la página de comparación.' },
        { type: 'h2', text: 'Lo que saco en claro: la calidad barata existe, pero es rara' },
        { type: 'p', text: 'Estas 14 acciones demuestran que la calidad barata existe. Pero no cae del cielo: hace falta una herramienta para encontrarla. Por eso precisamente construí mi screener, que cruza la puntuación de calidad con el P/FCF para cada acción que sigo. El screener completo te permite filtrar por sector, por nota y por múltiplo de valoración.' },
        { type: 'p', text: 'La lección es simple. No busques lo barato: busca la calidad barata. Juzga la empresa primero (¿es rentable, crece, tiene un balance sano?). Luego juzga el precio (¿está el P/FCF bajo?). Los dos juntos son raros. Cuando los encuentras, tienes algo.' },
        { type: 'p', text: 'Puedes encontrar la lista completa y actualizada continuamente en la página de acciones infravaloradas, analizar cualquier ticker en /analizar, o filtrar tú mismo en el screener. La calidad primero, el precio después: es todo lo que quería poder hacer, así que lo construí.' },
      ],
      faq: [
        { q: '¿Qué es la nota 10/10?', a: 'Es mi puntuación de calidad sobre 10, basada en 10 criterios financieros objetivos: rentabilidad, crecimiento de ventas y caja, recompras de acciones, deuda controlada, rentabilidad del capital. Juzga la solidez del negocio, al margen del precio de la acción. Una nota 10/10 no significa que haya que comprar: el precio también importa.' },
        { q: '¿Qué es el P/FCF en términos claros?', a: 'El P/FCF (price to free cash flow) compara el precio de la acción con el free cash flow que genera cada año. El free cash flow es el dinero que de verdad queda una vez pagadas todas las facturas. Un P/FCF de 8,4 significa que pagas 8,4 años de esa caja: cuanto más bajo, más barata cotiza la acción.' },
        { q: '¿Por qué algunas acciones no tienen P/FCF en la tabla?', a: 'Solo muestro los P/FCF de los que estoy seguro. Para los que faltan, puedes encontrarlos en la página de análisis de cada ticker, o en la clasificación completa de acciones infravaloradas actualizada continuamente.' },
        { q: '¿Una nota 10/10 y un P/FCF bajo garantizan una buena inversión?', a: 'No. Una nota 10/10 mide la calidad del negocio hoy, y un P/FCF bajo dice que el precio es barato. Pero el futuro puede cambiarlo todo: una empresa puede deteriorarse, un sector puede dar la vuelta. Este cruce da una base sólida, no una certeza. No es asesoramiento de inversión.' },
        { q: '¿Cómo puedo encontrar estas acciones yo mismo?', a: 'Puedes usar mi screener, que cruza la puntuación de calidad y el P/FCF para cientos de acciones. También puedes recorrer la clasificación de acciones infravaloradas o analizar un ticker concreto en la página de análisis.' },
      ],
      tags: ['Clasificación', '10/10', 'Infravaloradas', 'P/FCF', 'Análisis'],
      disclaimer:
        'Este artículo es un análisis con fines informativos y educativos y no constituye asesoramiento de inversión personalizado. Las rentabilidades pasadas no garantizan resultados futuros. Cifras a 10 de junio de 2026, sujetas a cambios. Haz tu propia investigación.',
    },
  },
...
const softwareSector: Article = {
  slug: 'meilleures-actions-software-qualite-2026',
  date: '2026-06-10',
  updated: '2026-06-10',
  readingTime: 10,
  content: {
    fr: {
      title: 'Meilleures actions Software 2026 : 9 titres notés 10/10',
      excerpt:
        "GoDaddy, Intuit, Roper Technologies, Salesforce et cinq autres : les 9 actions Software qui obtiennent ma note qualite maximale. Le palmares complet avec P/FCF, secteurs et mini-analyses.",
      metaDescription:
        'GoDaddy, Intuit, Roper Technologies, Salesforce et cinq autres : le palmares des actions Software notees 10/10 par Lubin Investment. Qualite, prix, P/FCF decortiques.',
      answer:
        'Neuf actions du secteur Software decrochent ma note qualite maximale 10/10. Elles couvrent a la fois le Software Application (Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk) et le Software Infrastructure (GoDaddy, Qualys). Toutes valident mes 10 criteres financiers objectifs, mais leurs prix varient du tres bon marche (GoDaddy a 8,4 fois son free cash flow) au premium (ServiceNow a 44,6 fois). Voici le palmares complet, secteur par secteur.',
      body: [
        { type: 'ul', items: [
          'Neuf actions du logiciel valident mes 10 criteres de qualite sur 10 : un score rare qui ne dit rien du prix, seulement de la solidite du business.',
          'Secteur Software Application : Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk.',
          'Secteur Software Infrastructure : GoDaddy, Qualys.',
          'Les prix s etagent du tres bon marche (GoDaddy a 8,4 fois son cash) au premium assume (ServiceNow a 44,6 fois).',
          'Ma regle, identique pour chaque ligne : la qualite d abord, le prix ensuite (et separement).',
        ]},
        { type: 'h2', text: 'Pourquoi ce palmares existe (et comment le lire)' },
        { type: 'p', text: "Avant de plonger dans la liste, un rappel sur ma methode, parce que c est elle qui donne son sens a tout ce qui suit. Je ne note pas une action a l intuition. Je passe chaque entreprise au crible de 10 criteres financiers objectifs, tous juges independamment du prix de l action : est elle vraiment rentable, ses ventes et son cash augmentent ils, rachete t elle ses actions plutot que de gaspiller, sa dette est elle maitrisable, son rendement du capital est il eleve ? Une entreprise qui coche tout obtient 10 sur 10. C est rare, par construction." },
        { type: 'p', text: "La note qualite ne dit rien du prix. Elle ne dit pas si l action est une bonne affaire aujourd hui. Elle dit seulement que le business derriere est solide. Pour mesurer le prix, j utilise un ratio different et totalement independant : le P/FCF (price to free cash flow). Le free cash flow, c est l argent qui reste vraiment dans les caisses une fois toutes les factures payees (salaires, machines, impots). Le P/FCF, c est le prix de l action divise par ce cash annuel. Un P/FCF de 8,4 veut dire que tu paies aujourd hui 8,4 annees de ce cash. Plus c est bas, moins c est cher." },
        { type: 'p', text: 'Voici pourquoi ce double regard est crucial : une entreprise geniale payee trop cher reste un mauvais placement. Une entreprise mediocre, meme b radee, reste mediocre. Les 9 actions ci dessous sont toutes excellentes sur la qualite. Mais leurs prix racontent des histoires tres differentes. C est a toi de trancher, avec tes propres objectifs et ta propre discipline de prix.' },
        { type: 'h2', text: 'Tableau comparatif des 9 actions Software notees 10/10' },
        { type: 'p', text: "Voici le tableau recapitulatif. Chaque ligne montre le ticker, la note qualite, le P/FCF et le sous secteur exact." },
        { type: 'p', text: 'GDDY (GoDaddy) | 10/10 | P/FCF 8,4x | Software Infrastructure' },
        { type: 'p', text: 'ROP (Roper Technologies) | 10/10 | P/FCF 13,8x | Software Application' },
        { type: 'p', text: 'INTU (Intuit) | 10/10 | P/FCF 14,2x | Software Application' },
        { type: 'p', text: 'CRM (Salesforce) | 10/10 | P/FCF 13,2x | Software Application' },
        { type: 'p', text: 'PCTY (Paylocity) | 10/10 | P/FCF 17,6x | Software Application' },
        { type: 'p', text: 'QLYS (Qualys) | 10/10 | P/FCF 18,2x | Software Infrastructure' },
        { type: 'p', text: 'BSY (Bentley Systems) | 10/10 | P/FCF 24,0x | Software Application' },
        { type: 'p', text: 'ADSK (Autodesk) | 10/10 | P/FCF 24,1x | Software Application' },
        { type: 'p', text: 'NOW (ServiceNow) | 10/10 | P/FCF 44,6x | Software Application' },
        { type: 'p', text: "Le prix le plus bas : GoDaddy a 8,4 fois son cash, un niveau quasi historique pour une entreprise d une telle qualite. Le plus haut : ServiceNow a 44,6 fois, signe que le marche price une croissance future exceptionnelle." },
        { type: 'h2', text: 'GoDaddy (GDDY) : le bon marche le plus solide du secteur' },
        { type: 'p', text: "GoDaddy est l exemple parfait de ce que je cherche : une qualite maximale (10/10) a un prix minimal. Son P/FCF de 8,4 fois le place parmi les actions les moins cheres de tout le secteur Software, et pourtant son business est d une solidite remarquable. GoDaddy ne se resum e pas a la vente de noms de domaine, meme si c est par la qu il commence. L entreprise a mute vers un modele de plateforme : hebergement, creation de sites web, marketing en ligne, emails professionnels. Ses clients, des petites entreprises et des independants, restent parce que son ecosysteme les retient : une fois que tu as ton site, ton email et ton nom de domaine chez le meme fournisseur, tu ne bouges pas." },
        { type: 'p', text: "Le chiffre qui m a frappe : sa marge de free cash flow tourne autour de 25 %, ce qui est excellent pour une entreprise de services. Et sa croissance du free cash flow par action depasse confortablement mon seuil de 10 % par an sur cinq ans. Bref, un business solide, bien gere, et qui se paie presque comme une valeur en declin. C est typiquement le genre de decalage que je trouve interessant. Tu peux consulter l analyse detaillee de GoDaddy." },
        { type: 'h2', text: 'Intuit (INTU) : le logiciel qui gere l argent des autres' },
        { type: 'p', text: "Intuit est une machine a cash meconnue du grand public. Tu connais peut etre TurboTax (declaration de revenus) ou QuickBooks (comptabilite des petites entreprises) sans savoir que les deux appartiennent a la meme societe. Derriere ces marques, il y a un modele economique redoutable : des abonnements que les clients renouvellent chaque annee parce que changer de logiciel comptable en cours d annee est un enfer administratif. Resultat, un taux de retention de la clientele superieur a 95 %, des marges elevees et un free cash flow qui croit regulierement." },
        { type: 'p', text: "A 14,2 fois son free cash flow, Intuit se paie dans la moyenne basse de son secteur. Ce n est pas une affaire flagrante comme GoDaddy, mais c est un prix raisonnable pour une entreprise dont la qualite est irreprochable. Le marche integre de l IA, avec son assistant financier Intuit Assist, commence a porter ses fruits et pourrait accelerer la croissance dans les annees a venir. Si tu veux creuser, la page d analyse d Intuit est disponible." },
        { type: 'h2', text: 'Salesforce (CRM) : le geant du CRM a prix de supermarche' },
        { type: 'p', text: "Salesforce est le leader inconteste du CRM (gestion de la relation client), un marche qu il a largement invente et qu il domine toujours. Pendant des annees, l action s est payee 40 a 60 fois son free cash flow. Aujourd hui, elle tourne autour de 13,2 fois. C est un multiple qu on associe d habitude a une entreprise industrielle, pas a un editeur de logiciels en croissance. Que s est il passe ?" },
        { type: 'p', text: "Le marche a sanctionne Salesforce pour son ralentissement de croissance et ses depenses parfois jug ees excessives. Mais sous la pression des investisseurs activistes, l entreprise a radicalement change de cap : elle a reduit ses effectifs, augmente ses marges, lance un programme de rachat d actions massif. Le free cash flow par action, lui, continue de croitre a un rythme soutenu, autour de 13 % par an sur cinq ans. A 13,2 fois ce cash, le marche ne paie presque aucune prime a Salesforce. C est le genre de situation ou un bon business a un prix decote merite qu on s y attarde. Voir la page d analyse de Salesforce." },
        { type: 'h2', text: 'Et les six autres, en bref' },
        { type: 'p', text: 'Roper Technologies (ROP) a 13,8 fois son cash est un conglomerat de logiciels de niche, un modele qui ressemble a un Berkshire Hathaway du logiciel : il achete des petites societes de logiciels hyper-specialisees, les garde et les laisse tourner sans les casser. Le resultat est un free cash flow stable et en croissance, a un prix raisonnable.' },
        { type: 'p', text: "Bentley Systems (BSY) a 24,0 fois est le leader des logiciels d infrastructure et de genie civil. C est plus cher que les precedents, mais son marche est captif : les ingenieurs qui concoivent des ponts ou des reseaux d eau n utilisent que Bentley. La marge de free cash flow depasse les 20 %." },
        { type: 'p', text: 'Paylocity (PCTY) a 17,6 fois est un editeur de logiciels de paie et de gestion des ressources humaines pour les PME americaines. Un abonnement collant (personne ne change de logiciel de paie en cours d annee), une croissance du cash par action qui depasse les 15 % par an.' },
        { type: 'p', text: "Qualys (QLYS) a 18,2 fois est un specialiste de la securite cloud et de la gestion des vulnerabilites. Son modele SaaS (Software as a Service) genere des revenus recurrents a tres forte marge. Le marche de la cybersecurite est structurellement porteur, et Qualys en est un acteur de premier plan." },
        { type: 'p', text: 'Autodesk (ADSK) a 24,1 fois est le roi du logiciel de conception assistee par ordinateur (CAO). AutoCAD, Revit, Fusion 360 : des noms que tout ingenieur ou architecte connait. Son passage au cloud et aux abonnements a transforme ses marges. Le prix est eleve, mais la qualite et le moat sont indeniablement la.' },
        { type: 'p', text: "ServiceNow (NOW) a 44,6 fois est le plus cher du palmares, et c est le seul qui merite veritablement son multiple eleve. ServiceNow automatise les processus informatiques et metiers des grandes entreprises. Sa plateforme est devenue l epine dorsale de milliers d organisations, avec un taux de retention proche de 99 %. La croissance du free cash flow par action tourne autour de 25 % par an, assez pour justifier un prix premium. Mais il faut etre pret a payer cette qualite." },
        { type: 'h2', text: 'Ce que j en retiens' },
        { type: 'p', text: 'Ces 9 actions partagent toutes une qualite maximale. Mais leurs prix racontent neuf histoires differentes. GoDaddy est bon marche comme si le marche doutait de lui. Salesforce a ete sanctionne pour son passe. Intuit est raisonnable sans etre une affaire. ServiceNow merite son premium parce que sa croissance le justifie.' },
        { type: 'p', text: "Ma regle ne change pas, quelle que soit la ligne du tableau : je juge la qualite du business d abord, le prix ensuite. Si tu veux explorer toi meme, tu peux filtrer toutes les actions notees 10/10 dans mon classement qualite, ou les comparer directement via le screener. Et si tu veux comprendre ma methode en detail, elle est expliquee sur la page de methodologie." },
      ],
      faq: [
        { q: 'C est quoi, la note qualite 10/10 de Lubin Investment ?', a: "C est une note sur 10 qui mesure la solidite financiere d une entreprise a travers 10 criteres objectifs : rentabilite, croissance des ventes et du cash, rachats d actions, marge de free cash flow, rendement du capital, endettement, conversion du benefice en cash. La note est independante du prix de l action. Un 10/10 signifie que le business coche tous mes criteres." },
        { q: 'C est quoi, le P/FCF (price to free cash flow) ?', a: "Le P/FCF est le prix de l action divise par le free cash flow qu elle genere chaque annee. Le free cash flow est l argent qui reste vraiment dans les caisses une fois toutes les factures payees. Un P/FCF de 13,2 signifie que tu paies aujourd hui 13,2 annees de ce cash. Plus le chiffre est bas, moins l action est chere." },
        { q: 'Pourquoi le titre dit 9 titres alors que le secteur en contient plus ?', a: "Parmi les actions du secteur Software notees 10/10, j ai selectionne les 9 les plus equilibrees en termes de qualite et de prix. J ai laisse de cote les cas extremes comme Shopify (P/FCF de 85,7 fois) qui, malgre une note maximale, se paie a un niveau qui depasse ma zone de confort." },
        { q: 'Faut il acheter toutes ces actions ?', a: "Non. La note qualite maximale ne dit rien du prix. Certaines sont bon marche (GoDaddy a 8,4 fois), d autres sont tres cheres (ServiceNow a 44,6 fois). La decision d achat depend de tes objectifs, de ta tolerance au risque et de ta discipline de prix. Ceci n est pas un conseil en investissement, fais tes propres recherches." },
        { q: 'Est ce que ces notes et P/FCF sont mis a jour regulierement ?', a: "Oui, les notes qualite et les P/FCF sont recalcules en continu a chaque nouveau chiffre publie par les entreprises. Les donnees de cet article sont celles au 10 juin 2026." },
      ],
      tags: ['Analyse', 'Software', 'Palmares', 'Qualite'],
      disclaimer:
        "Analyse a but informatif et educatif, pas un conseil en investissement personnalise. Les performances passees ne prejugent pas du futur. Chiffres a la date de publication, susceptibles d evolver. Fais tes propres recherches.",
    },
    en: {
      title: 'Best Software Stocks 2026 : 9 stocks rated 10/10',
      excerpt:
        'GoDaddy, Intuit, Roper Technologies, Salesforce and five more : the 9 Software stocks that earn my maximum quality score. Full ranking with P/FCF, sectors and deep dives.',
      metaDescription:
        'GoDaddy, Intuit, Roper Technologies, Salesforce and five more : the ranking of Software stocks rated 10/10 by Lubin Investment. Quality, price, P/FCF explained.',
      answer:
        'Nine Software stocks earn my maximum 10/10 quality score. They cover both Software Application (Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk) and Software Infrastructure (GoDaddy, Qualys). All pass my 10 objective financial criteria, but their prices range from very cheap (GoDaddy at 8.4 times free cash flow) to premium (ServiceNow at 44.6 times). Here is the full sector ranking.',
      body: [
        { type: 'ul', items: [
          'Nine software stocks pass all 10 of my quality criteria : a rare score that says nothing about price, only about business soundness.',
          'Software Application sector : Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk.',
          'Software Infrastructure sector : GoDaddy, Qualys.',
          'Prices range from very cheap (GoDaddy at 8.4 times cash) to premium (ServiceNow at 44.6 times).',
          'My rule, the same for every line : quality first, price second (and separately).',
        ]},
        { type: 'h2', text: 'Why this ranking exists (and how to read it)' },
        { type: 'p', text: "Before diving into the list, a reminder of my method, because it is what gives meaning to everything that follows. I do not score a stock by gut feel. I run each company through 10 objective financial criteria, all judged independently of the stock price : is it truly profitable, are sales and cash growing, does it buy back shares rather than waste capital, is its debt manageable, is its return on capital high? A company that checks every box earns 10 out of 10. That is rare by design." },
        { type: 'p', text: "The quality score says nothing about price. It does not tell you whether the stock is a bargain today. It only tells you that the underlying business is sound. To measure price, I use a different and fully independent ratio : the P/FCF (price to free cash flow). Free cash flow is the money that truly stays in the bank once every bill is paid (salaries, machines, taxes). The P/FCF divides the share price by that yearly cash. A P/FCF of 8.4 means you are paying 8.4 years of that cash today. The lower it is, the cheaper." },
        { type: 'p', text: "Here is why this dual view matters : a great company bought too expensive is still a bad investment. A mediocre company, even dirt cheap, stays mediocre. All 9 stocks below are excellent on quality. But their prices tell very different stories. It is up to you to decide, with your own goals and your own price discipline." },
        { type: 'h2', text: 'Comparison table of the 9 Software stocks rated 10/10' },
        { type: 'p', text: 'Here is the summary table. Each row shows the ticker, quality score, P/FCF and exact sub-sector.' },
        { type: 'p', text: 'GDDY (GoDaddy) | 10/10 | P/FCF 8.4x | Software Infrastructure' },
        { type: 'p', text: 'ROP (Roper Technologies) | 10/10 | P/FCF 13.8x | Software Application' },
        { type: 'p', text: 'INTU (Intuit) | 10/10 | P/FCF 14.2x | Software Application' },
        { type: 'p', text: 'CRM (Salesforce) | 10/10 | P/FCF 13.2x | Software Application' },
        ...
        { type: 'p', text: 'ADSK (Autodesk) | 10/10 | P/FCF 24.1x | Software Application' },
        { type: 'p', text: 'NOW (ServiceNow) | 10/10 | P/FCF 44.6x | Software Application' },
        { type: 'p', text: 'The cheapest : GoDaddy at 8.4 times its cash, a near-historic level for a business this solid. The most expensive : ServiceNow at 44.6 times, signalling the market prices exceptional future growth.' },
        { type: 'h2', text: 'GoDaddy (GDDY) : the cheapest quality in the sector' },
        { type: 'p', text: "GoDaddy is the perfect example of what I look for : maximum quality (10/10) at a minimum price. Its P/FCF of 8.4 times places it among the cheapest stocks in the entire Software sector, yet its business is remarkably solid. GoDaddy is not just domain name sales, even if that is where it starts. The company has shifted toward a platform model : hosting, website creation, online marketing, professional email. Its customers, small businesses and freelancers, stay because its ecosystem holds them : once you have your site, email and domain with the same provider, you do not move." },
        { type: 'p', text: 'The number that struck me : its free cash flow margin runs around 25 %, excellent for a services company. And its free cash flow per share growth comfortably exceeds my 10 % annual threshold over five years. In short, a solid, well-run business that trades almost like a declining value. That is exactly the kind of gap I find interesting. You can see the full analysis of GoDaddy.' },
        { type: 'h2', text: "Intuit (INTU) : the software that manages other people s money" },
        { type: 'p', text: "Intuit is a cash machine that flies under the general public's radar. You may know TurboTax (tax filing) or QuickBooks (small business accounting) without realizing both belong to the same company. Behind those brands lies a formidable economic model : subscriptions that customers renew every year because switching accounting software mid-year is an administrative nightmare. The result : a customer retention rate above 95 %, high margins and steadily growing free cash flow." },
        { type: 'p', text: 'At 14.2 times its free cash flow, Intuit trades in the low range of its sector. It is not a screaming bargain like GoDaddy, but it is a reasonable price for a company with flawless quality. The embedded AI features, including its Intuit Assist financial assistant, are beginning to pay off and could accelerate growth in coming years. If you want to dig in, the Intuit analysis page is available.' },
        { type: 'h2', text: 'Salesforce (CRM) : the CRM giant at a bargain price' },
        { type: 'p', text: "Salesforce is the undisputed leader in CRM (customer relationship management), a market it largely invented and still dominates. For years, the stock traded at 40 to 60 times free cash flow. Today it runs around 13.2 times. That is a multiple usually associated with an industrial company, not a growing software publisher. What happened ?" },
        { type: 'p', text: "The market penalized Salesforce for its slowing growth and sometimes excessive spending. But under activist investor pressure, the company radically pivoted : it cut headcount, expanded margins, and launched a massive share buyback program. Free cash flow per share keeps growing at a solid pace, around 13 % per year over five years. At 13.2 times that cash, the market barely assigns any premium to Salesforce. That is the kind of situation where a good business at a discounted price deserves a closer look. See the Salesforce analysis page." },
        { type: 'h2', text: 'And the other six, in brief' },
        { type: 'p', text: 'Roper Technologies (ROP) at 13.8 times its cash is a niche software conglomerate, a model resembling a Berkshire Hathaway of software : it buys highly specialized small software companies, keeps them and lets them run without breaking them. The result is stable and growing free cash flow at a reasonable price.' },
        { type: 'p', text: 'Bentley Systems (BSY) at 24.0 times is the leader in infrastructure and civil engineering software. It is pricier than the previous ones, but its market is captive : engineers designing bridges or water networks only use Bentley. The free cash flow margin exceeds 20 %.' },
        { type: 'p', text: 'Paylocity (PCTY) at 17.6 times is a payroll and HR software provider for US SMBs. A sticky subscription (nobody switches payroll software mid-year), cash per share growth exceeding 15 % per year.' },
        { type: 'p', text: 'Qualys (QLYS) at 18.2 times is a cloud security and vulnerability management specialist. Its SaaS (Software as a Service) model generates highly recurring revenue with strong margins. The cybersecurity market is structurally growing, and Qualys is a leading player.' },
        { type: 'p', text: 'Autodesk (ADSK) at 24.1 times is the king of computer-aided design (CAD) software. AutoCAD, Revit, Fusion 360 : names every engineer or architect knows. Its transition to cloud and subscriptions transformed its margins. The price is high, but the quality and moat are undeniable.' },
        { type: 'p', text: 'ServiceNow (NOW) at 44.6 times is the most expensive in the ranking, and the only one that truly earns its premium multiple. ServiceNow automates IT and business processes for large enterprises. Its platform has become the backbone of thousands of organizations, with a retention rate near 99 %. Free cash flow per share growth runs around 25 % per year, enough to justify a premium price. But you have to be willing to pay for that quality.' },
        { type: 'h2', text: 'What I take away from this' },
        { type: 'p', text: 'These 9 stocks all share maximum quality. But their prices tell nine different stories. GoDaddy is cheap as if the market doubts it. Salesforce was penalized for its past. Intuit is reasonable without being a bargain. ServiceNow earns its premium because its growth justifies it.' },
        { type: 'p', text: 'My rule does not change, no matter which row of the table : I judge the business quality first, the price second. If you want to explore yourself, you can filter all 10/10 stocks in my quality ranking, or compare them directly through the screener. And if you want to understand my method in detail, it is explained on the methodology page.' },
      ],
      faq: [
        { q: 'What is the 10/10 quality score from Lubin Investment ?', a: "It is a score out of 10 that measures a company's financial soundness across 10 objective criteria : profitability, sales and cash growth, share buybacks, free cash flow margin, return on capital, debt level, cash conversion. The score is independent of the stock price. A 10/10 means the business passes all my criteria." },
        { q: 'What is the P/FCF (price to free cash flow) ?', a: 'The P/FCF is the share price divided by the free cash flow the company generates each year. Free cash flow is the money that truly stays in the bank once every bill is paid. A P/FCF of 13.2 means you are paying 13.2 years of that cash today. The lower the number, the cheaper the stock.' },
        { q: 'Why does the title say 9 stocks when the sector has more ?', a: 'Among the Software stocks rated 10/10, I selected the 9 most balanced in terms of quality and price. I left out extreme cases like Shopify (P/FCF of 85.7 times) which, despite a maximum score, trades at a level beyond my comfort zone.' },
        { q: 'Should I buy all of these stocks ?', a: 'No. A maximum quality score says nothing about price. Some are cheap (GoDaddy at 8.4 times), others are very expensive (ServiceNow at 44.6 times). The buy decision depends on your goals, risk tolerance and price discipline. This is not investment advice, do your own research.' },
        { q: 'Are these scores and P/FCF ratios updated regularly ?', a: 'Yes, quality scores and P/FCF ratios are recalculated continuously as companies publish new figures. The data in this article is as of June 10, 2026.' },
      ],
      tags: ['Analysis', 'Software', 'Ranking', 'Quality'],
      disclaimer:
        'Analysis for informational and educational purposes, not personalized investment advice. Past performance does not guarantee future results. Figures as of the publication date, subject to change. Do your own research.',
    },
    es: {
      title: 'Mejores acciones Software 2026 : 9 valores puntuados 10/10',
      excerpt:
        'GoDaddy, Intuit, Roper Technologies, Salesforce y cinco mas : las 9 acciones de Software que obtienen mi puntuacion maxima de calidad. Ranking completo con P/FCF, sectores y analisis.',
      metaDescription:
        'GoDaddy, Intuit, Roper Technologies, Salesforce y cinco mas : el ranking de acciones Software puntuadas 10/10 por Lubin Investment. Calidad, precio, P/FCF explicados.',
      answer:
        'Nueve acciones del sector Software obtienen mi puntuacion maxima de calidad 10/10. Cubren tanto Software Application (Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk) como Software Infrastructure (GoDaddy, Qualys). Todas pasan mis 10 criterios financieros objetivos, pero sus precios van desde muy barato (GoDaddy a 8,4 veces su flujo de caja libre) hasta premium (ServiceNow a 44,6 veces). Aqui esta el ranking completo por sector.',
      body: [
        { type: 'ul', items: [
          'Nueve acciones de software pasan todos mis 10 criterios de calidad : una puntuacion rara que no dice nada sobre el precio, solo sobre la solidez del negocio.',
          'Sector Software Application : Roper Technologies, Bentley Systems, Intuit, Salesforce, ServiceNow, Paylocity, Autodesk.',
          'Sector Software Infrastructure : GoDaddy, Qualys.',
          'Los precios van desde muy barato (GoDaddy a 8,4 veces su caja) hasta premium (ServiceNow a 44,6 veces).',
          'Mi regla, identica para cada linea : la calidad primero, el precio despues (y por separado).',
        ]},
        { type: 'h2', text: 'Por que existe este ranking (y como leerlo)' },
        { type: 'p', text: 'Antes de sumergirnos en la lista, un recordatorio de mi metodo, porque es lo que da sentido a todo lo que sigue. No puntuo una accion por intuicion. Paso cada empresa por 10 criterios financieros objetivos, todos juzgados independientemente del precio de la accion : es realmente rentable, crecen sus ventas y su caja, recompra acciones en vez de malgastar capital, es manejable su deuda, es alto su rendimiento del capital ? Una empresa que cumple todo obtiene un 10 sobre 10. Es raro por construccion.' },
        { type: 'p', text: 'La puntuacion de calidad no dice nada sobre el precio. No dice si la accion es una ganga hoy. Solo dice que el negocio subyacente es solido. Para medir el precio uso un ratio distinto y totalmente independiente : el P/FCF (price to free cash flow). El flujo de caja libre es el dinero que de verdad queda en caja una vez pagadas todas las facturas (salarios, maquinas, impuestos). El P/FCF divide el precio de la accion por esa caja anual. Un P/FCF de 8,4 significa que pagas hoy 8,4 anos de esa caja. Cuanto mas bajo, mas barato.' },
        { type: 'p', text: 'He aqui por que esta doble vision importa : una empresa genial comprada demasiado cara sigue siendo una mala inversion. Una empresa mediocre, aunque este tirada de precio, sigue siendo mediocre. Las 9 acciones de abajo son todas excelentes en calidad. Pero sus precios cuentan historias muy distintas. Depende de ti decidir, con tus propios objetivos y tu propia disciplina de precio.' },
        { type: 'h2', text: 'Tabla comparativa de las 9 acciones Software puntuadas 10/10' },
        { type: 'p', text: 'Aqui esta la tabla resumen. Cada fila muestra el ticker, la puntuacion de calidad, el P/FCF y el subsector exacto.' },
        { type: 'p', text: 'GDDY (GoDaddy) | 10/10 | P/FCF 8,4x | Software Infrastructure' },
        { type: 'p', text: 'ROP (Roper Technologies) | 10/10 | P/FCF 13,8x | Software Application' },
        { type: 'p', text: 'INTU (Intuit) | 10/10 | P/FCF 14,2x | Software Application' },
        { type: 'p', text: 'CRM (Salesforce) | 10/10 | P/FCF 13,2x | Software Application' },
        ...
        { type: 'p', text: 'ADSK (Autodesk) | 10/10 | P/FCF 24,1x | Software Application' },
        { type: 'p', text: 'NOW (ServiceNow) | 10/10 | P/FCF 44,6x | Software Application' },
        { type: 'p', text: 'El mas barato : GoDaddy a 8,4 veces su caja, un nivel casi historico para un negocio tan solido. El mas caro : ServiceNow a 44,6 veces, senal de que el mercado descuenta un crecimiento futuro excepcional.' },
        { type: 'h2', text: 'GoDaddy (GDDY) : la calidad mas barata del sector' },
        { type: 'p', text: 'GoDaddy es el ejemplo perfecto de lo que busco : calidad maxima (10/10) a un precio minimo. Su P/FCF de 8,4 veces lo coloca entre las acciones mas baratas de todo el sector Software, y sin embargo su negocio es de una solidez notable. GoDaddy no se reduce a la venta de nombres de dominio, aunque por ahi empiece. La empresa ha mutado hacia un modelo de plataforma : alojamiento, creacion de sitios web, marketing en linea, correos profesionales. Sus clientes, pequenas empresas y autonomos, se quedan porque su ecosistema los retiene : una vez que tienes tu sitio, tu correo y tu dominio con el mismo proveedor, no te mueves.' },
        { type: 'p', text: 'La cifra que me sorprendio : su margen de flujo de caja libre ronda el 25 %, excelente para una empresa de servicios. Y su crecimiento del flujo de caja libre por accion supera comodamente mi umbral del 10 % anual en cinco anos. En resumen, un negocio solido, bien gestionado, y que cotiza casi como un valor en declive. Es tipicamente el tipo de desfase que encuentro interesante. Puedes consultar el analisis detallado de GoDaddy.' },
        { type: 'h2', text: 'Intuit (INTU) : el software que gestiona el dinero ajeno' },
        { type: 'p', text: 'Intuit es una maquina de caja poco conocida del gran publico. Quizas conozcas TurboTax (declaracion de impuestos) o QuickBooks (contabilidad para pymes) sin saber que ambas pertenecen a la misma empresa. Detras de esas marcas hay un modelo economico formidable : suscripciones que los clientes renuevan cada ano porque cambiar de software contable a mitad de ano es una pesadilla administrativa. El resultado : una tasa de retencion de clientes superior al 95 %, margenes elevados y un flujo de caja libre que crece con regularidad.' },
        { type: 'p', text: 'A 14,2 veces su flujo de caja libre, Intuit cotiza en la franja baja de su sector. No es una ganga flagrante como GoDaddy, pero es un precio razonable para una empresa con una calidad irreprochable. Las funciones integradas de IA, incluido su asistente financiero Intuit Assist, empiezan a dar frutos y podrian acelerar el crecimiento en los proximos anos. Si quieres profundizar, la pagina de analisis de Intuit esta disponible.' },
        { type: 'h2', text: 'Salesforce (CRM) : el gigante del CRM a precio de supermercado' },
        { type: 'p', text: 'Salesforce es el lider indiscutible del CRM (gestion de relaciones con clientes), un mercado que invento en gran medida y que sigue dominando. Durante anos, la accion cotizo a 40 o 60 veces su flujo de caja libre. Hoy ronda las 13,2 veces. Es un multiple que se asocia normalmente a una empresa industrial, no a un editor de software en crecimiento. Que paso ?' },
        { type: 'p', text: 'El mercado sanciono a Salesforce por su ralentizacion del crecimiento y sus gastos a veces considerados excesivos. Pero bajo la presion de inversores activistas, la empresa cambio radicalmente de rumbo : redujo plantilla, aumento margenes y lanzo un programa masivo de recompra de acciones. El flujo de caja libre por accion sigue creciendo a un ritmo solido, en torno al 13 % anual en cinco anos. A 13,2 veces esa caja, el mercado apenas asigna prima alguna a Salesforce. Es el tipo de situacion en que un buen negocio a precio descontado merece atencion. Ver la pagina de analisis de Salesforce.' },
        { type: 'h2', text: 'Y las otras seis, en breve' },
        { type: 'p', text: 'Roper Technologies (ROP) a 13,8 veces su caja es un conglomerado de software de nicho, un modelo que se asemeja a un Berkshire Hathaway del software : compra empresas de software pequenas y muy especializadas, las conserva y las deja funcionar sin romperlas. El resultado es un flujo de caja libre estable y creciente a un precio razonable.' },
        { type: 'p', text: 'Bentley Systems (BSY) a 24,0 veces es el lider en software de infraestructura e ingenieria civil. Es mas caro que los anteriores, pero su mercado es cautivo : los ingenieros que disenan puentes o redes de agua solo usan Bentley. El margen de flujo de caja libre supera el 20 %.' },
        { type: 'p', text: 'Paylocity (PCTY) a 17,6 veces es un proveedor de software de nomina y recursos humanos para pymes estadounidenses. Una suscripcion pegajosa (nadie cambia de software de nomina a mitad de ano), un crecimiento de la caja por accion que supera el 15 % anual.' },
        { type: 'p', text: 'Qualys (QLYS) a 18,2 veces es un especialista en seguridad en la nube y gestion de vulnerabilidades. Su modelo SaaS genera ingresos recurrentes con margenes muy altos. El mercado de la ciberseguridad estructuralmente crece, y Qualys es un actor lider.' },
        { type: 'p', text: 'Autodesk (ADSK) a 24,1 veces es el rey del software de diseno asistido por ordenador (CAD). AutoCAD, Revit, Fusion 360 : nombres que todo ingeniero o arquitecto conoce. Su transicion a la nube y las suscripciones transformo sus margenes. El precio es alto, pero la calidad y el foso son innegables.' },
        { type: 'p', text: 'ServiceNow (NOW) a 44,6 veces es el mas caro del ranking, y el unico que realmente merece su multiple premium. ServiceNow automatiza procesos informaticos y de negocio para grandes empresas. Su plataforma se ha convertido en la columna vertebral de miles de organizaciones, con una tasa de retencion cercana al 99 %. El crecimiento del flujo de caja libre por accion ronda el 25 % anual, suficiente para justificar un precio premium. Pero hay que estar dispuesto a pagar esa calidad.' },
        { type: 'h2', text: 'Lo que concluyo de esto' },
        { type: 'p', text: 'Estas 9 acciones comparten todas una calidad maxima. Pero sus precios cuentan nueve historias distintas. GoDaddy es barato como si el mercado dudara de el. Salesforce fue sancionado por su pasado. Intuit es razonable sin ser una ganga. ServiceNow merece su prima porque su crecimiento lo justifica.' },
        { type: 'p', text: 'Mi regla no cambia, independientemente de la fila de la tabla : juzgo la calidad del negocio primero, el precio despues. Si quieres explorar tu mismo, puedes filtrar todas las acciones puntuadas 10/10 en mi clasificacion de calidad, o compararlas directamente a traves del screener. Y si quieres entender mi metodo en detalle, esta explicado en la pagina de metodologia.' },
      ],
      faq: [
        { q: 'Que es la puntuacion de calidad 10/10 de Lubin Investment ?', a: 'Es una puntuacion sobre 10 que mide la solidez financiera de una empresa a traves de 10 criterios objetivos : rentabilidad, crecimiento de ventas y caja, recompras de acciones, margen de flujo de caja libre, rendimiento del capital, endeudamiento, conversion del beneficio en caja. La puntuacion es independiente del precio de la accion. Un 10/10 significa que el negocio cumple todos mis criterios.' },
        { q: 'Que es el P/FCF (price to free cash flow) ?', a: 'El P/FCF es el precio de la accion dividido por el flujo de caja libre que genera cada ano. El flujo de caja libre es el dinero que de verdad queda en caja una vez pagadas todas las facturas. Un P/FCF de 13,2 significa que pagas hoy 13,2 anos de esa caja. Cuanto mas bajo el numero, mas barata la accion.' },
        { q: 'Por que el titulo dice 9 valores si el sector tiene mas ?', a: 'Entre las acciones del sector Software puntuadas 10/10, seleccione las 9 mas equilibradas en terminos de calidad y precio. Deje fuera casos extremos como Shopify (P/FCF de 85,7 veces) que, pese a una puntuacion maxima, cotiza a un nivel que supera mi zona de confort.' },
        { q: 'Debo comprar todas estas acciones ?', a: 'No. La puntuacion maxima de calidad no dice nada sobre el precio. Algunas son baratas (GoDaddy a 8,4 veces), otras son muy caras (ServiceNow a 44,6 veces). La decision de compra depende de tus objetivos, tolerancia al riesgo y disciplina de precio. Esto no es asesoramiento de inversion, haz tu propia investigacion.' },
        { q: 'Se actualizan estas puntuaciones y P/FCF regularmente ?', a: 'Si, las puntuaciones de calidad y los P/FCF se recalculan continuamente a medida que las empresas publican nuevas cifras. Los datos de este articulo corresponden al 10 de junio de 2026.' },
      ],
      tags: ['Analisis', 'Software', 'Ranking', 'Calidad'],
      disclaimer:
        'Este articulo es un analisis con fines informativos y educativos y no constituye asesoramiento de inversion personalizado. Las rentabilidades pasadas no garantizan resultados futuros. Cifras a 10 de junio de 2026, sujetas a cambios. Haz tu propia investigacion.',
    },
  },
};

const qualite10: Article = {
  slug: '10-criteres-qualite-action-analyse-fondamentale',
  date: '2026-06-10',
  updated: '2026-06-10',
  readingTime: 9,
  content: {
    fr: {
      title: 'Note 10/10 : les 10 critères de qualité d\'une action expliqués',
      excerpt: 'Rentabilité, croissance du cash, endettement maîtrisé, rendement du capital : voici les 10 critères objectifs qui décident si une action mérite la note maximale, expliqués simplement.',
      metaDescription: 'Les 10 critères objectifs de la note qualité Lubin : rentabilité, croissance du cash, rachats d\'actions, marges, endettement, rendement du capital. Comprends notre grille d\'analyse fondamentale sans jargon.',
      answer: 'La note qualité /10 de Lubin Investment évalue une entreprise sur 10 critères financiers objectifs, sans opinion humaine. Rentabilité durable, croissance du chiffre d\'affaires et du free cash flow, rachats d\'actions, marges suffisantes, endettement maîtrisé, rendement du capital élevé : chaque critère est validé ou non selon des seuils issus de la littérature financière. La qualité du business et le prix de l\'action sont jugés séparément.',
      body: [
        { type: 'ul', items: [
          'Les 10 critères de qualité mesurent la solidité du business indépendamment du prix de l\'action : rentabilité, croissance du cash, rachats d\'actions, marges, endettement, rendement du capital.',
          'Chaque critère validé rapporte 1 point : une note de 10/10 est rare et signale une entreprise d\'élite sur le plan fondamental.',
          'Un 10/10 ne garantit pas un bon investissement : une entreprise géniale payée trop cher reste un mauvais placement. Qualité et prix jugés séparément.',
          'Les seuils sont issus de la recherche de Buffett, Damodaran et Mauboussin, pas d\'une opinion.',
          'Exemples : GoDaddy (GDDY) 10/10 à P/FCF 8,4x, Kinsale Capital (KNSL) 10/10 à 7,0x, Adobe (ADBE) 9/10 à 11,7x.',
        ] },
        { type: 'h2', text: 'Pourquoi je sépare la qualité du prix' },
        { type: 'p', text: 'La première fois que j\'ai commencé à analyser des actions sérieusement, je faisais l\'erreur classique : je voyais un P/E bas, je pensais « bonne affaire ». Sauf que parfois le P/E est bas parce que l\'entreprise décline pour de bon. Et inversement : une action chère peut être une excellente société qui vaut chaque centime. Une entreprise géniale payée trop cher reste un mauvais placement. Une entreprise médiocre, même bradée, reste médiocre. Depuis, j\'ai construit une grille qui répond d\'abord à la première question : est-ce une bonne entreprise ? Dix critères financiers objectifs. La note /10 qui en sort ne dit rien du prix. Elle dit seulement si le business est solide. Ensuite seulement, je regarde si le prix est raisonnable via le P/FCF.' },
        { type: 'h2', text: 'Les 10 critères de la note qualité' },
        { type: 'h2', text: '1. Rentabilité durable : l\'entreprise gagne-t-elle de l\'argent ?' },
        { type: 'p', text: 'Premier filtre : le bénéfice net est-il positif ? Pas de profits, pas de qualité, sauf cas très spécifiques (biotech en R&D). Le seuil est bas : vérifier que la machine ne tourne pas à perte structurellement.' },
        { type: 'h2', text: '2. Marge nette suffisante : que reste-t-il de chaque euro de vente ?' },
        { type: 'p', text: 'La marge nette mesure ce qui reste du chiffre d\'affaires une fois toutes les charges payées. Mon seuil est 10 % : sur 100 euros de ventes, au moins 10 doivent finir en bénéfice net. Adobe atteint 34 % de marge de free cash flow, Kinsale Capital 52 %.' },
        { type: 'h2', text: '3. Croissance du chiffre d\'affaires : les ventes augmentent-elles ?' },
        { type: 'p', text: 'Une entreprise qui ne grandit pas recule sur la durée. Je regarde la progression du chiffre d\'affaires : au moins 10 % de croissance annualisée sur cinq ans. C\'est une mesure de si le marché qu\'elle sert existe encore et si elle gagne des parts.' },
        { type: 'h2', text: '4. Croissance du free cash flow par action : le vrai cash progresse-t-il ?' },
        { type: 'p', text: 'Le free cash flow par action est plus difficile à maquiller que le chiffre d\'affaires. S\'il progresse d\'au moins 10 % par an, l\'entreprise crée de la valeur pour ses actionnaires de façon concrète. C\'est le critère le plus discriminant : Adobe (+10,9 %) le passe, Microsoft (+4,8 %) non.' },
        { type: 'h2', text: '5. Rachats d\'actions : l\'entreprise rend-elle du capital aux actionnaires ?' },
        { type: 'p', text: 'Une entreprise de qualité ne gaspille pas son cash en acquisitions hasardeuses. Idéalement, elle rachète ses propres actions : cela réduit le nombre de titres et concentre la valeur sur les actionnaires restants. Je vérifie que le nombre d\'actions ne progresse pas.' },
        { type: 'h2', text: '6. Rendement du capital (Cash ROCE) : chaque euro investi rapporte-t-il assez ?' },
        { type: 'p', text: 'Le Cash ROCE répond à une question simple : pour chaque euro mis dans le business, combien de cash en ressort chaque année ? Mon seuil est 15 %. Kinsale Capital atteint 45 %, soit environ trois fois le seuil d\'excellence. Un Cash ROCE élevé signale un vrai moat.' },
        { type: 'h2', text: '7. Conversion bénéfice / cash : le profit comptable devient-il du cash réel ?' },
        { type: 'p', text: 'Je mesure le ratio de conversion : le free cash flow divisé par le bénéfice net. Un ratio supérieur à 1 signifie que le cash généré dépasse le bénéfice affiché (Kinsale à 1,89). En dessous de 0,5, je m\'inquiète (Microsoft à 0,48, à cause de ses investissements dans l\'IA).' },
        { type: 'h2', text: '8. Endettement maîtrisé : la dette est-elle sous contrôle ?' },
        { type: 'p', text: 'Trop de dette transforme une bonne entreprise en passager fragile. Je regarde le ratio dette nette sur EBITDA. Un maximum de 3 fois. Kinsale Capital n\'a pas de dette nette : sa trésorerie couvre la totalité de ses emprunts.' },
        { type: 'h2', text: '9. Stabilité du cash : le free cash flow fluctue-t-il trop ?' },
        { type: 'p', text: 'Un business de qualité génère un free cash flow prévisible. Trop de volatilité d\'une année sur l\'autre signale un modèle fragile dépendant de facteurs extérieurs.' },
        { type: 'h2', text: '10. Transformation des bénéfices : l\'entreprise investit-elle intelligemment ?' },
        { type: 'p', text: 'Une entreprise avec un Cash ROCE supérieur à 15 % et qui rachète ses actions signale une allocation intelligente du capital. Si le cash s\'accumule sans projet ni redistribution, le management manque d\'imagination.' },
        { type: 'h2', text: 'Ce qu\'un 10/10 dit vraiment (et ce qu\'il ne dit pas)' },
        { type: 'p', text: 'Un 10/10 est rare : sur les milliers d\'actions analysées, seulement 74 obtiennent la note maximale. Mais il ne dit pas si l\'action est un bon achat aujourd\'hui. Parmi ces 74, certaines se paient 85 fois leur cash (Shopify), d\'autres 4 fois (SkyWest). La qualité est une condition nécessaire, pas suffisante. Tu peux retrouver la grille complète sur ma page de méthodologie, et l\'appliquer à n\'importe quelle action.' },
      ],
      faq: [
        { q: 'Comment une note 10/10 est-elle calculée ?', a: 'Chacun des 10 critères est validé (OUI, PARTIEL, NON) selon des seuils chiffrés issus de la recherche financière. Un OUI rapporte 1 point. La note est la somme des points. Aucune opinion humaine n\'intervient.' },
        { q: 'Un 10/10 garantit-il que l\'action va monter ?', a: 'Non. La note mesure la solidité du business, pas le prix. Une entreprise 10/10 peut baisser si elle est trop chère ou si son secteur est en crise. C\'est pourquoi je juge qualité et prix séparément.' },
        { q: 'Qui a fixé les seuils ?', a: 'Les seuils viennent de Buffett (rentabilité du capital), Mauboussin (réinvestissement), Damodaran (endettement). Mon travail a été de les automatiser.' },
        { q: 'Combien d\'actions obtiennent 10/10 ?', a: 'Environ 74 actions sur plusieurs milliers, délibérément rare pour signaler une excellence incontestable.' },
      ],
      tags: ['Méthodologie', 'Analyse fondamentale', 'Qualité'],
      disclaimer: "Analyse à but informatif et éducatif, pas un conseil en investissement personnalisé. Les performances passées ne préjugent pas des performances futures. Chiffres au 10 juin 2026, susceptibles d'évoluer. Fais tes propres recherches.",
    },
    en: {
      title: '10/10 score : the 10 quality criteria for stocks explained',
      excerpt: 'Profitability, cash growth, manageable debt, return on capital : these are the 10 objective criteria that decide if a stock deserves top marks.',
      metaDescription: 'The 10 objective criteria behind Lubin\'s quality score : profitability, cash growth, buybacks, margins, debt, return on capital. Understand our fundamental analysis without the jargon.',
      answer: 'Lubin Investment\'s quality score rates a company on 10 objective financial criteria, with no human opinion. Sustainable profitability, revenue and free cash flow growth, share buybacks, adequate margins, manageable debt, high return on capital : each criterion is passed or failed according to academic thresholds. Business quality and stock price are judged separately.',
      body: [
        { type: 'ul', items: [
          'The 10 quality criteria measure business strength independently of stock price : profitability, cash growth, buybacks, margins, debt, return on capital.',
          'Each passed criterion scores 1 point : a 10/10 rating is rare and signals a fundamentally elite company.',
          'A 10/10 does not guarantee a good investment : a great company bought too expensive is still a bad investment.',
          'Thresholds come from Buffett, Damodaran and Mauboussin, not opinion.',
          'Examples : GoDaddy (GDDY) 10/10 at 8.4x P/FCF, Kinsale Capital (KNSL) 10/10 at 7.0x, Adobe (ADBE) 9/10 at 11.7x.',
        ] },
        { type: 'h2', text: 'Why I separate quality from price' },
        { type: 'p', text: 'When I first started analysing stocks seriously, I made the classic mistake : I saw a low P/E and thought "bargain". Except sometimes the P/E is low because the company is genuinely in decline. A great company bought too expensive is still a bad investment. I built a grid that answers the first question first : is this a good business ? Ten objective financial criteria. Only then do I check if the price is reasonable via P/FCF.' },
        { type: 'h2', text: 'The 10 quality criteria' },
        { type: 'h2', text: '1. Sustainable profitability' },
        { type: 'p', text: 'First filter : is net income positive ? No profits, no quality, except for specific cases like biotech in R&D. The check is whether the machine runs at a loss structurally.' },
        { type: 'h2', text: '2. Adequate net margin' },
        { type: 'p', text: 'Net margin measures what remains of revenue after all expenses. My threshold is 10 %. Adobe reaches 34 % free cash flow margin, Kinsale Capital 52 %.' },
        { type: 'h2', text: '3. Revenue growth' },
        { type: 'p', text: 'A company that does not grow declines over time. I look for at least 10 % annualised growth over five years.' },
        { type: 'h2', text: '4. Free cash flow per share growth' },
        { type: 'p', text: 'Free cash flow per share is harder to dress up than revenue. If it grows at least 10 % a year, the company creates tangible value. Adobe (+10.9 %) passes, Microsoft (+4.8 %) does not.' },
        { type: 'h2', text: '5. Share buybacks' },
        { type: 'p', text: 'A quality company buys back its own shares rather than wasting cash. I check that the share count is not rising.' },
        { type: 'h2', text: '6. Return on capital (Cash ROCE)' },
        { type: 'p', text: 'For each dollar put into the business, how much cash comes out each year ? My threshold is 15 %. Kinsale Capital reaches 45 %, roughly three times the excellence threshold.' },
        { type: 'h2', text: '7. Earnings-to-cash conversion' },
        { type: 'p', text: 'Free cash flow divided by net income. Above 1 means cash exceeds stated profit (Kinsale at 1.89). Below 0.5 is worrying (Microsoft at 0.48 due to AI investment).' },
        { type: 'h2', text: '8. Manageable debt' },
        { type: 'p', text: 'Net debt to EBITDA max 3x. Kinsale Capital has no net debt : its cash covers all borrowings.' },
        { type: 'h2', text: '9. Cash stability' },
        { type: 'p', text: 'A quality business generates predictable free cash flow. Too much volatility signals a fragile model.' },
        { type: 'h2', text: '10. Intelligent investment' },
        { type: 'p', text: 'Cash ROCE above 15 % plus share buybacks signals smart capital allocation. Cash piling up with no projects suggests poor management.' },
        { type: 'h2', text: 'What a 10/10 truly means' },
        { type: 'p', text: 'A 10/10 is rare : only 74 stocks out of thousands achieve it. But it does not tell you whether the stock is a good buy today. Among those 74, some trade at 85 times cash (Shopify), others at 4 times (SkyWest). Quality is necessary, not sufficient.' },
      ],
      faq: [
        { q: 'How is a 10/10 score calculated ?', a: 'Each criterion is validated (YES, PARTIAL, NO) according to numerical thresholds. A YES scores 1 point. The score is the sum, from 0 to 10. No human opinion.' },
        { q: 'Does a 10/10 guarantee the stock will rise ?', a: 'No. The score measures business strength, not price. A 10/10 company can decline if overpriced. Quality and price are separate.' },
        { q: 'How many stocks score 10/10 ?', a: 'About 74 stocks out of thousands, deliberately rare to signal unquestionable excellence.' },
      ],
      tags: ['Methodology', 'Fundamental Analysis', 'Quality'],
      disclaimer: 'Analysis for informational and educational purposes, not personalized investment advice. Past performance does not guarantee future results. Figures as of June 10, 2026, subject to change. Do your own research.',
    },
    es: {
      title: 'Nota 10/10 : los 10 criterios de calidad de una acción explicados',
      excerpt: 'Rentabilidad, crecimiento de la caja, deuda controlada, rentabilidad del capital : los 10 criterios objetivos que deciden si una acción merece la nota máxima.',
      metaDescription: 'Los 10 criterios objetivos de la nota calidad Lubin : rentabilidad, crecimiento de la caja, recompras, márgenes, deuda, rentabilidad del capital. Entiende nuestro análisis fundamental sin jerga.',
      answer: 'La nota de calidad /10 de Lubin Investment evalúa una empresa con 10 criterios financieros objetivos, sin opinión humana. Rentabilidad sostenible, crecimiento de ingresos y flujo de caja libre, recompras, márgenes suficientes, deuda controlada, alta rentabilidad del capital. La calidad y el precio se juzgan por separado.',
      body: [
        { type: 'ul', items: [
          'Los 10 criterios miden la solidez del negocio independientemente del precio de la acción.',
          'Cada criterio validado suma 1 punto : un 10/10 es raro y señala una empresa de élite.',
          'Un 10/10 no garantiza una buena inversión : calidad y precio se juzgan por separado.',
          'Ejemplos : GoDaddy (GDDY) 10/10 a P/FCF 8,4x, Kinsale Capital (KNSL) 10/10 a 7,0x.',
        ] },
        { type: 'h2', text: 'Los 10 criterios de calidad' },
        { type: 'h2', text: '1. Rentabilidad sostenible' },
        { type: 'p', text: 'El beneficio neto es positivo. Sin beneficios no hay calidad, salvo casos específicos como biotecnología en I+D.' },
        { type: 'h2', text: '2. Margen neto suficiente' },
        { type: 'p', text: 'De cada 100 euros de ventas, al menos 10 deben acabar en beneficio neto. Adobe alcanza el 34 % de margen de flujo de caja libre.' },
        { type: 'h2', text: '3. Crecimiento de ingresos' },
        { type: 'p', text: 'Busco al menos un 10 % de crecimiento anualizado en cinco años.' },
        { type: 'h2', text: '4. Crecimiento del flujo de caja libre por acción' },
        { type: 'p', text: 'Es el criterio más discriminante : Adobe (+10,9 %) lo pasa, Microsoft (+4,8 %) no.' },
        { type: 'h2', text: '5. Recompra de acciones' },
        { type: 'p', text: 'Compruebo que el número de acciones no aumente, diluyendo a los accionistas.' },
        { type: 'h2', text: '6. Rentabilidad del capital (Cash ROCE)' },
        { type: 'p', text: 'Mi umbral es del 15 %. Kinsale Capital alcanza el 45 %, tres veces el umbral de excelencia.' },
        { type: 'h2', text: '7. Conversión beneficio/caja' },
        { type: 'p', text: 'Por encima de 1 es excelente (Kinsale a 1,89). Por debajo de 0,5 es preocupante.' },
        { type: 'h2', text: '8. Deuda controlada' },
        { type: 'p', text: 'Deuda neta sobre EBITDA máximo 3 veces. Kinsale no tiene deuda neta.' },
        { type: 'h2', text: '9. Estabilidad de la caja' },
        { type: 'p', text: 'Un negocio de calidad genera flujo de caja libre predecible sin volatilidad excesiva.' },
        { type: 'h2', text: '10. Inversión inteligente' },
        { type: 'p', text: 'Cash ROCE superior al 15 % y recompra de acciones señalan asignación inteligente de capital.' },
        { type: 'h2', text: 'Lo que un 10/10 significa realmente' },
        { type: 'p', text: 'Solo 74 acciones de miles obtienen la nota máxima. Pero no dice si la acción es una buena compra hoy : algunas se pagan 85 veces su caja, otras 4 veces.' },
      ],
      faq: [
        { q: '¿Cómo se calcula un 10/10 ?', a: 'Cada criterio se valida (SÍ, PARCIAL, NO) según umbrales numéricos. Un SÍ suma 1 punto. Sin opinión humana.' },
        { q: '¿Un 10/10 garantiza que la acción suba ?', a: 'No. Mide la solidez del negocio, no el precio. Calidad y precio se juzgan por separado.' },
      ],
      tags: ['Metodología', 'Análisis fundamental', 'Calidad'],
      disclaimer: 'Análisis con fines informativos y educativos, no asesoramiento de inversión personalizado. Las rentabilidades pasadas no garantizan resultados futuros. Cifras a 10 de junio de 2026, sujetas a cambios. Haz tu propia investigación.',
    },
  },
};

export const ARTICLES: Article[] = [qualite10, techPfcf, rotation, kinsale, adobe, palmares14, softwareSector];
