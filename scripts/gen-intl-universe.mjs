...
const EXCHANGES = [
  ...
  { seg: 'ASX',     suffix: '.AX', group: 'AUSTRALIA',    label: 'Australie · ASX (.AX)',         cap: 2500, country: 'home:Australia' },
  { seg: 'TYO',     suffix: '.T',  group: 'JAPAN',        label: 'Japon · Tokyo (.T)',            cap: 2500, country: 'exUsNull' },
  { seg: 'HKG',     suffix: '.HK', group: 'HONG_KONG',    label: 'Hong Kong (.HK)',               cap: 2500, country: 'exUsNull' },
  { seg: 'SHA',     suffix: '.SS', group: 'SHANGHAI',     label: 'Chine · Shanghai (.SS)',        cap: 4000, country: 'exUsNull' },
  { seg: 'SHE',     suffix: '.SZ', group: 'SHENZHEN',     label: 'Chine · Shenzhen (.SZ)',        cap: 4000, country: 'exUsNull' },
  { seg: 'KRX',     suffix: '.KS', group: 'KOREA',        label: 'Corée · Séoul (.KS)',           cap: 2500, country: 'exUsNull' },
  { seg: 'TPE',     suffix: '.TW', group: 'TAIWAN',       label: 'Taïwan (.TW)',                  cap: 1200, country: 'exUsNull' },
  { seg: 'NSE',     suffix: '.NS', group: 'INDIA',        label: 'Inde · NSE (.NS)',              cap: 2500, country: 'exUsNull' },
